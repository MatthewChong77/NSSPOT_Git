...
// where we can't use inline assembly paths.
    ...
    #if defined(GEMMLOWP_SSE4) && defined(GEMMLOWP_X86_32) && !defined(GEMMLOWP_DISABLE_SSE4)
    ...
    #if defined(GEMMLOWP_SSE4) && defined(GEMMLOWP_X86_64) && !defined(GEMMLOWP_DISABLE_SSE4)
