...
// ACLE intrinsics under groups __ARM_FEATURE_QBIT, __ARM_FEATURE_DSP , __ARM_FEATURE_SAT,
...
// __smlad is defined by GCC, but results in a performance drop(Tested on Arm GNU Toolchain
