 ...
 */
    ...
    #pragma GCC diagnostic ignored                                                                 \
        "-Wpedantic" /* disable pedantic warning due to unnamed structs/unions */
#endif
...
typedef struct {
    ...
    __IOM uint8_t SHPR[12U];  /*!< Offset: 0x018 (R/W)  System Handlers Priority Registers (4-7,
                                 8-11, 12-15) */
    ...
    __OM uint32_t BPIALL;   /*!< Offset: 0x278 ( /W)  Branch Predictor Invalidate All */
        ...
        #define SCB_ICSR_NMIPENDSET_Pos                                                            \
            SCB_ICSR_PENDNMISET_Pos /*!< SCB ICSR: NMIPENDSET Position, backward compatibility */
        #define SCB_ICSR_NMIPENDSET_Msk                                                            \
            SCB_ICSR_PENDNMISET_Msk /*!< SCB ICSR: NMIPENDSET Mask, backward compatibility */
        ...
        #define SCB_AIRCR_DIT_Msk                                                                  \
            (1UL << SCB_AIRCR_DIT_Pos) /*!< SCB AIRCR: Data Independent Timing Mask */
        ...
        #define SCB_CFSR_MEMFAULTSR_Msk                                                            \
            (0xFFUL /*<< SCB_CFSR_MEMFAULTSR_Pos*/) /*!< SCB CFSR: Memory Manage Fault Status      \
                                                       Register Mask */
        ...
        #define SCB_ID_DFR_MProfDbg_Msk                                                            \
            (0xFUL << SCB_ID_DFR_MProfDbg_Pos) /*!< SCB ID_DFR: MProfDbg Mask */
...
typedef struct {
    ...
    __IOM uint32_t CPPWR; /*!< Offset: 0x00C (R/W)  Coprocessor Power Control  Register */
        ...
        #define ICB_ACTLR_DISCRITAXIRUW_Msk                                                        \
        ...
        #define ICB_ACTLR_DISCRITAXIRUR_Msk                                                        \
            (1UL << ICB_ACTLR_DISCRITAXIRUR_Pos) /*!< ACTLR: DISCRITAXIRUR Mask */

        #define ICB_ACTLR_EVENTBUSEN_Pos 14U /*!< ACTLR: EVENTBUSEN Position */
        #define ICB_ACTLR_EVENTBUSEN_Msk                                                           \
            (1UL << ICB_ACTLR_EVENTBUSEN_Pos) /*!< ACTLR: EVENTBUSEN Mask */

        #define ICB_ACTLR_EVENTBUSEN_S_Pos 13U /*!< ACTLR: EVENTBUSEN_S Position */
        #define ICB_ACTLR_EVENTBUSEN_S_Msk                                                         \
            (1UL << ICB_ACTLR_EVENTBUSEN_S_Pos) /*!< ACTLR: EVENTBUSEN_S Mask */
        ...
        #define ICB_ACTLR_DISNWAMODE_Msk                                                           \
            (1UL << ICB_ACTLR_DISNWAMODE_Pos) /*!< ACTLR: DISNWAMODE Mask */

        #define ICB_ACTLR_FPEXCODIS_Pos 10U /*!< ACTLR: FPEXCODIS Position */
        #define ICB_ACTLR_FPEXCODIS_Msk                                                            \
            (1UL << ICB_ACTLR_FPEXCODIS_Pos) /*!< ACTLR: FPEXCODIS Mask */
        ...
        #define ICB_ACTLR_DISOLAPS_Msk                                                             \
            (1UL << ICB_ACTLR_DISOLAPS_Pos) /*!< ACTLR: DISOLAPS Mask                              \
                                             */
        ...
        #define ICB_ACTLR_DISLOLEP_Msk                                                             \
            (1UL << ICB_ACTLR_DISLOLEP_Pos) /*!< ACTLR: DISLOLEP Mask                              \
                                             */
        ...
        #define ICB_ICTR_INTLINESNUM_Msk                                                           \
            (0xFUL /*<< ICB_ICTR_INTLINESNUM_Pos*/) /*!< ICTR: INTLINESNUM Mask */
...
typedef struct {
    ...
    __IM uint32_t CID3;    /*!< Offset: 0xFFC (R/ )  ITM Component  Identification Register #3 */
        ...
        #define ITM_ITREAD_AFVALID_Msk                                                             \
            (0x1UL << ITM_ITREAD_AFVALID_Pos) /*!< ITM ITREAD: AFVALID Mask */

        #define ITM_ITREAD_ATREADY_Pos 0U /*!< ITM ITREAD: ATREADY Position */
        #define ITM_ITREAD_ATREADY_Msk                                                             \
            (0x1UL /*<< ITM_ITREAD_ATREADY_Pos*/) /*!< ITM ITREAD: ATREADY Mask */

        /* ITM Integration Write Register Definitions */
        #define ITM_ITWRITE_AFVALID_Pos 1U /*!< ITM ITWRITE: AFVALID Position */
        #define ITM_ITWRITE_AFVALID_Msk                                                            \
            (0x1UL << ITM_ITWRITE_AFVALID_Pos) /*!< ITM ITWRITE: AFVALID Mask */

        #define ITM_ITWRITE_ATREADY_Pos 0U /*!< ITM ITWRITE: ATREADY Position */
        #define ITM_ITWRITE_ATREADY_Msk                                                            \
            (0x1UL /*<< ITM_ITWRITE_ATREADY_Pos*/) /*!< ITM ITWRITE: ATREADY Mask */
...
typedef struct {
    ...
    __IOM uint32_t DTGU_LUT[16U]; /*!< Offset: 0x610 (R/W)  DTGU Look Up Table Register */
        ...
        #define MEMSYSCTL_MSCR_DCCLEAN_Msk                                                         \
            (0x1UL << MEMSYSCTL_MSCR_DCCLEAN_Pos) /*!< MEMSYSCTL MSCR: DCCLEAN Mask */

        #define MEMSYSCTL_MSCR_ICACTIVE_Pos 13U /*!< MEMSYSCTL MSCR: ICACTIVE Position */
        #define MEMSYSCTL_MSCR_ICACTIVE_Msk                                                        \
            (0x1UL << MEMSYSCTL_MSCR_ICACTIVE_Pos) /*!< MEMSYSCTL MSCR: ICACTIVE Mask */

        #define MEMSYSCTL_MSCR_DCACTIVE_Pos 12U /*!< MEMSYSCTL MSCR: DCACTIVE Position */
        #define MEMSYSCTL_MSCR_DCACTIVE_Msk                                                        \
            (0x1UL << MEMSYSCTL_MSCR_DCACTIVE_Pos) /*!< MEMSYSCTL MSCR: DCACTIVE Mask */

        #define MEMSYSCTL_MSCR_TECCCHKDIS_Pos 4U /*!< MEMSYSCTL MSCR: TECCCHKDIS Position */
        #define MEMSYSCTL_MSCR_TECCCHKDIS_Msk                                                      \
            (0x1UL << MEMSYSCTL_MSCR_TECCCHKDIS_Pos) /*!< MEMSYSCTL MSCR: TECCCHKDIS Mask */

        #define MEMSYSCTL_MSCR_EVECCFAULT_Pos 3U /*!< MEMSYSCTL MSCR: EVECCFAULT Position */
        #define MEMSYSCTL_MSCR_EVECCFAULT_Msk                                                      \
            (0x1UL << MEMSYSCTL_MSCR_EVECCFAULT_Pos) /*!< MEMSYSCTL MSCR: EVECCFAULT Mask */

        #define MEMSYSCTL_MSCR_FORCEWT_Pos 2U /*!< MEMSYSCTL MSCR: FORCEWT Position */
        #define MEMSYSCTL_MSCR_FORCEWT_Msk                                                         \
            (0x1UL << MEMSYSCTL_MSCR_FORCEWT_Pos) /*!< MEMSYSCTL MSCR: FORCEWT Mask */

        #define MEMSYSCTL_MSCR_ECCEN_Pos 1U /*!< MEMSYSCTL MSCR: ECCEN Position */
        #define MEMSYSCTL_MSCR_ECCEN_Msk                                                           \
            (0x1UL << MEMSYSCTL_MSCR_ECCEN_Pos) /*!< MEMSYSCTL MSCR: ECCEN Mask */
        ...
        #define MEMSYSCTL_PFCR_ENABLE_Msk                                                          \
            (0x1UL /*<< MEMSYSCTL_PFCR_ENABLE_Pos*/) /*!< MEMSYSCTL PFCR: ENABLE Mask */
        ...
        #define MEMSYSCTL_ITCMCR_SZ_Msk                                                            \
            (0xFUL << MEMSYSCTL_ITCMCR_SZ_Pos) /*!< MEMSYSCTL ITCMCR: SZ Mask */
        ...
        #define MEMSYSCTL_DTCMCR_SZ_Msk                                                            \
            (0xFUL << MEMSYSCTL_DTCMCR_SZ_Pos) /*!< MEMSYSCTL DTCMCR: SZ Mask */
        ...
        #define MEMSYSCTL_PAHBCR_SZ_Msk                                                            \
            (0x7UL << MEMSYSCTL_PAHBCR_SZ_Pos) /*!< MEMSYSCTL PAHBCR: SZ Mask */
        ...
        #define MEMSYSCTL_ITGU_CTRL_DEREN_Msk                                                      \
            (0x1UL << MEMSYSCTL_ITGU_CTRL_DEREN_Pos) /*!< MEMSYSCTL ITGU_CTRL: DEREN Mask */

        #define MEMSYSCTL_ITGU_CTRL_DBFEN_Pos 0U /*!< MEMSYSCTL ITGU_CTRL: DBFEN Position */
        #define MEMSYSCTL_ITGU_CTRL_DBFEN_Msk                                                      \
            (0x1UL /*<< MEMSYSCTL_ITGU_CTRL_DBFEN_Pos*/) /*!< MEMSYSCTL ITGU_CTRL: DBFEN Mask */
        ...
        #define MEMSYSCTL_DTGU_CTRL_DEREN_Msk                                                      \
            (0x1UL << MEMSYSCTL_DTGU_CTRL_DEREN_Pos) /*!< MEMSYSCTL DTGU_CTRL: DEREN Mask */

        #define MEMSYSCTL_DTGU_CTRL_DBFEN_Pos 0U /*!< MEMSYSCTL DTGU_CTRL: DBFEN Position */
        #define MEMSYSCTL_DTGU_CTRL_DBFEN_Msk                                                      \
            (0x1UL /*<< MEMSYSCTL_DTGU_CTRL_DBFEN_Pos*/) /*!< MEMSYSCTL DTGU_CTRL: DBFEN Mask */
...
typedef struct {
    __IOM uint32_t
        CPDLPSTATE; /*!< Offset: 0x000 (R/W)  Core Power Domain Low Power State Register */
    __IOM uint32_t
        DPDLPSTATE; /*!< Offset: 0x004 (R/W)  Debug Power Domain Low Power State Register */
} PwrModCtl_Type;

        /* PWRMODCTL Core Power Domain Low Power State (CPDLPSTATE) Register Definitions */
        #define PWRMODCTL_CPDLPSTATE_RLPSTATE_Pos                                                  \
            8U /*!< PWRMODCTL CPDLPSTATE: RLPSTATE Position                                        \
                */
        #define PWRMODCTL_CPDLPSTATE_RLPSTATE_Msk                                                  \
            (0x3UL << PWRMODCTL_CPDLPSTATE_RLPSTATE_Pos) /*!< PWRMODCTL CPDLPSTATE: RLPSTATE Mask  \
                                                          */

        #define PWRMODCTL_CPDLPSTATE_ELPSTATE_Pos                                                  \
            4U /*!< PWRMODCTL CPDLPSTATE: ELPSTATE Position                                        \
                */
        #define PWRMODCTL_CPDLPSTATE_ELPSTATE_Msk                                                  \
            (0x3UL << PWRMODCTL_CPDLPSTATE_ELPSTATE_Pos) /*!< PWRMODCTL CPDLPSTATE: ELPSTATE Mask  \
                                                          */

        #define PWRMODCTL_CPDLPSTATE_CLPSTATE_Pos                                                  \
            0U /*!< PWRMODCTL CPDLPSTATE: CLPSTATE Position                                        \
                */
        #define PWRMODCTL_CPDLPSTATE_CLPSTATE_Msk                                                  \
            (0x3UL /*<< PWRMODCTL_CPDLPSTATE_CLPSTATE_Pos*/) /*!< PWRMODCTL CPDLPSTATE: CLPSTATE   \
                                                                Mask */

        /* PWRMODCTL Debug Power Domain Low Power State (DPDLPSTATE) Register Definitions */
        #define PWRMODCTL_DPDLPSTATE_DLPSTATE_Pos                                                  \
            0U /*!< PWRMODCTL DPDLPSTATE: DLPSTATE Position                                        \
                */
        #define PWRMODCTL_DPDLPSTATE_DLPSTATE_Msk                                                  \
            (0x3UL /*<< PWRMODCTL_DPDLPSTATE_DLPSTATE_Pos*/) /*!< PWRMODCTL DPDLPSTATE: DLPSTATE   \
                                                                Mask */
...
typedef struct {
    ...
    __IM uint32_t EWIC_PSR; /*!< Offset: 0x600 (R/ )  EWIC Pend Summary Register */
        ...
        #define EWIC_EWIC_CR_EN_Msk                                                                \
            (0x1UL /*<< EWIC_EWIC_CR_EN_Pos*/) /*!< EWIC EWIC_CR: EN Mask                          \
                                                */
        ...
        #define EWIC_EWIC_ASCR_ASPU_Msk                                                            \
            (0x1UL << EWIC_EWIC_ASCR_ASPU_Pos) /*!< EWIC EWIC_ASCR: ASPU Mask */

        #define EWIC_EWIC_ASCR_ASPD_Pos 0U /*!< EWIC EWIC_ASCR: ASPD Position */
        #define EWIC_EWIC_ASCR_ASPD_Msk                                                            \
            (0x1UL /*<< EWIC_EWIC_ASCR_ASPD_Pos*/) /*!< EWIC EWIC_ASCR: ASPD Mask */

        /* EWIC Event Number ID (EWIC_NUMID) Register Definitions */
        #define EWIC_EWIC_NUMID_NUMEVENT_Pos 0U /*!< EWIC_NUMID: NUMEVENT Position */
        #define EWIC_EWIC_NUMID_NUMEVENT_Msk                                                       \
            (0xFFFFUL /*<< EWIC_EWIC_NUMID_NUMEVENT_Pos*/) /*!< EWIC_NUMID: NUMEVENT Mask */

        /* EWIC Mask A (EWIC_MASKA) Register Definitions */
        #define EWIC_EWIC_MASKA_EDBGREQ_Pos 2U /*!< EWIC EWIC_MASKA: EDBGREQ Position */
        #define EWIC_EWIC_MASKA_EDBGREQ_Msk                                                        \
            (0x1UL << EWIC_EWIC_MASKA_EDBGREQ_Pos) /*!< EWIC EWIC_MASKA: EDBGREQ Mask */

        #define EWIC_EWIC_MASKA_NMI_Pos 1U /*!< EWIC EWIC_MASKA: NMI Position */
        #define EWIC_EWIC_MASKA_NMI_Msk                                                            \
            (0x1UL << EWIC_EWIC_MASKA_NMI_Pos) /*!< EWIC EWIC_MASKA: NMI Mask */

        #define EWIC_EWIC_MASKA_EVENT_Pos 0U /*!< EWIC EWIC_MASKA: EVENT Position */
        #define EWIC_EWIC_MASKA_EVENT_Msk                                                          \
            (0x1UL /*<< EWIC_EWIC_MASKA_EVENT_Pos*/) /*!< EWIC EWIC_MASKA: EVENT Mask */

        /* EWIC Mask n (EWIC_MASKn) Register Definitions */
        #define EWIC_EWIC_MASKn_IRQ_Pos 0U /*!< EWIC EWIC_MASKn: IRQ Position */
        #define EWIC_EWIC_MASKn_IRQ_Msk                                                            \
            (0xFFFFFFFFUL /*<< EWIC_EWIC_MASKn_IRQ_Pos*/) /*!< EWIC EWIC_MASKn: IRQ Mask */

        /* EWIC Pend A (EWIC_PENDA) Register Definitions */
        #define EWIC_EWIC_PENDA_EDBGREQ_Pos 2U /*!< EWIC EWIC_PENDA: EDBGREQ Position */
        #define EWIC_EWIC_PENDA_EDBGREQ_Msk                                                        \
            (0x1UL << EWIC_EWIC_PENDA_EDBGREQ_Pos) /*!< EWIC EWIC_PENDA: EDBGREQ Mask */

        #define EWIC_EWIC_PENDA_NMI_Pos 1U /*!< EWIC EWIC_PENDA: NMI Position */
        #define EWIC_EWIC_PENDA_NMI_Msk                                                            \
            (0x1UL << EWIC_EWIC_PENDA_NMI_Pos) /*!< EWIC EWIC_PENDA: NMI Mask */

        #define EWIC_EWIC_PENDA_EVENT_Pos 0U /*!< EWIC EWIC_PENDA: EVENT Position */
        #define EWIC_EWIC_PENDA_EVENT_Msk                                                          \
            (0x1UL /*<< EWIC_EWIC_PENDA_EVENT_Pos*/) /*!< EWIC EWIC_PENDA: EVENT Mask */

        /* EWIC Pend n (EWIC_PENDn) Register Definitions */
        #define EWIC_EWIC_PENDn_IRQ_Pos 0U /*!< EWIC EWIC_PENDn: IRQ Position */
        #define EWIC_EWIC_PENDn_IRQ_Msk                                                            \
            (0xFFFFFFFFUL /*<< EWIC_EWIC_PENDn_IRQ_Pos*/) /*!< EWIC EWIC_PENDn: IRQ Mask */

        /* EWIC Pend Summary (EWIC_PSR) Register Definitions */
        #define EWIC_EWIC_PSR_NZ_Pos 1U /*!< EWIC EWIC_PSR: NZ Position */
        #define EWIC_EWIC_PSR_NZ_Msk                                                               \
            (0x7FFFUL << EWIC_EWIC_PSR_NZ_Pos) /*!< EWIC EWIC_PSR: NZ Mask */

        #define EWIC_EWIC_PSR_NZA_Pos 0U /*!< EWIC EWIC_PSR: NZA Position */
        #define EWIC_EWIC_PSR_NZA_Msk                                                              \
            (0x1UL /*<< EWIC_EWIC_PSR_NZA_Pos*/) /*!< EWIC EWIC_PSR: NZA Mask */

/*@}*/ /* end of group EWIC_Type */

/**
  \ingroup  CMSIS_core_register
  \defgroup EWIC_ISA_Type     External Wakeup Interrupt Controller (EWIC) interrupt status access
  registers \brief    Type definitions for the External Wakeup Interrupt Controller interrupt status
  access registers (EWIC_ISA)
  @{
 */

/**
  \brief  Structure type to access the External Wakeup Interrupt Controller interrupt status access
  registers (EWIC_ISA).
 */
typedef struct {
    ...
    __IM uint32_t EVENTMASKn[15]; /*!< Offset: 0x084 (R/ )  Event Mask Register */
        ...
        #define EWIC_ISA_EVENTSPR_EDBGREQ_Msk                                                      \
            (0x1UL << EWIC_ISA_EVENTSPR_EDBGREQ_Pos) /*!< EWIC_ISA EVENTSPR: EDBGREQ Mask */

        #define EWIC_ISA_EVENTSPR_NMI_Pos 1U /*!< EWIC_ISA EVENTSPR: NMI Position */
        #define EWIC_ISA_EVENTSPR_NMI_Msk                                                          \
            (0x1UL << EWIC_ISA_EVENTSPR_NMI_Pos) /*!< EWIC_ISA EVENTSPR: NMI Mask */

        #define EWIC_ISA_EVENTSPR_EVENT_Pos 0U /*!< EWIC_ISA EVENTSPR: EVENT Position */
        #define EWIC_ISA_EVENTSPR_EVENT_Msk                                                        \
            (0x1UL /*<< EWIC_ISA_EVENTSPR_EVENT_Pos*/) /*!< EWIC_ISA EVENTSPR: EVENT Mask */
        ...
        #define EWIC_ISA_EVENTMASKA_EDBGREQ_Msk                                                    \
            (0x1UL << EWIC_ISA_EVENTMASKA_EDBGREQ_Pos) /*!< EWIC_ISA EVENTMASKA: EDBGREQ Mask */

        #define EWIC_ISA_EVENTMASKA_NMI_Pos 1U /*!< EWIC_ISA EVENTMASKA: NMI Position */
        #define EWIC_ISA_EVENTMASKA_NMI_Msk                                                        \
            (0x1UL << EWIC_ISA_EVENTMASKA_NMI_Pos) /*!< EWIC_ISA EVENTMASKA: NMI Mask */

        #define EWIC_ISA_EVENTMASKA_EVENT_Pos 0U /*!< EWIC_ISA EVENTMASKA: EVENT Position */
        #define EWIC_ISA_EVENTMASKA_EVENT_Msk                                                      \
            (0x1UL /*<< EWIC_ISA_EVENTMASKA_EVENT_Pos*/) /*!< EWIC_ISA EVENTMASKA: EVENT Mask */
        ...
        #define EWIC_ISA_EVENTMASKn_IRQ_Msk                                                        \
            (0xFFFFFFFFUL /*<< EWIC_ISA_EVENTMASKn_IRQ_Pos*/) /*!< EWIC_ISA EVENTMASKn: IRQ Mask   \
                                                               */
...
typedef struct {
    ...
    __IOM uint32_t TEBR1; /*!< Offset: 0x028 (R/W)  TCM Error Bank Register 1 */
        ...
        #define ERRBNK_IEBR0_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_IEBR0_SWDEF_Pos) /*!< ERRBNK IEBR0: SWDEF Mask */

        #define ERRBNK_IEBR0_BANK_Pos 16U /*!< ERRBNK IEBR0: BANK Position */
        #define ERRBNK_IEBR0_BANK_Msk                                                              \
            (0x1UL << ERRBNK_IEBR0_BANK_Pos) /*!< ERRBNK IEBR0: BANK Mask */

        #define ERRBNK_IEBR0_LOCATION_Pos 2U /*!< ERRBNK IEBR0: LOCATION Position */
        #define ERRBNK_IEBR0_LOCATION_Msk                                                          \
            (0x3FFFUL << ERRBNK_IEBR0_LOCATION_Pos) /*!< ERRBNK IEBR0: LOCATION Mask */

        #define ERRBNK_IEBR0_LOCKED_Pos 1U /*!< ERRBNK IEBR0: LOCKED Position */
        #define ERRBNK_IEBR0_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_IEBR0_LOCKED_Pos) /*!< ERRBNK IEBR0: LOCKED Mask */

        #define ERRBNK_IEBR0_VALID_Pos 0U /*!< ERRBNK IEBR0: VALID Position */
        #define ERRBNK_IEBR0_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_IEBR0_VALID_Pos*/) /*!< ERRBNK IEBR0: VALID Mask */
        ...
        #define ERRBNK_IEBR1_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_IEBR1_SWDEF_Pos) /*!< ERRBNK IEBR1: SWDEF Mask */

        #define ERRBNK_IEBR1_BANK_Pos 16U /*!< ERRBNK IEBR1: BANK Position */
        #define ERRBNK_IEBR1_BANK_Msk                                                              \
            (0x1UL << ERRBNK_IEBR1_BANK_Pos) /*!< ERRBNK IEBR1: BANK Mask */

        #define ERRBNK_IEBR1_LOCATION_Pos 2U /*!< ERRBNK IEBR1: LOCATION Position */
        #define ERRBNK_IEBR1_LOCATION_Msk                                                          \
            (0x3FFFUL << ERRBNK_IEBR1_LOCATION_Pos) /*!< ERRBNK IEBR1: LOCATION Mask */

        #define ERRBNK_IEBR1_LOCKED_Pos 1U /*!< ERRBNK IEBR1: LOCKED Position */
        #define ERRBNK_IEBR1_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_IEBR1_LOCKED_Pos) /*!< ERRBNK IEBR1: LOCKED Mask */

        #define ERRBNK_IEBR1_VALID_Pos 0U /*!< ERRBNK IEBR1: VALID Position */
        #define ERRBNK_IEBR1_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_IEBR1_VALID_Pos*/) /*!< ERRBNK IEBR1: VALID Mask */
        ...
        #define ERRBNK_DEBR0_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_DEBR0_SWDEF_Pos) /*!< ERRBNK DEBR0: SWDEF Mask */

        #define ERRBNK_DEBR0_TYPE_Pos 17U /*!< ERRBNK DEBR0: TYPE Position */
        #define ERRBNK_DEBR0_TYPE_Msk                                                              \
            (0x1UL << ERRBNK_DEBR0_TYPE_Pos) /*!< ERRBNK DEBR0: TYPE Mask */

        #define ERRBNK_DEBR0_BANK_Pos 16U /*!< ERRBNK DEBR0: BANK Position */
        #define ERRBNK_DEBR0_BANK_Msk                                                              \
            (0x1UL << ERRBNK_DEBR0_BANK_Pos) /*!< ERRBNK DEBR0: BANK Mask */

        #define ERRBNK_DEBR0_LOCATION_Pos 2U /*!< ERRBNK DEBR0: LOCATION Position */
        #define ERRBNK_DEBR0_LOCATION_Msk                                                          \
            (0x3FFFUL << ERRBNK_DEBR0_LOCATION_Pos) /*!< ERRBNK DEBR0: LOCATION Mask */

        #define ERRBNK_DEBR0_LOCKED_Pos 1U /*!< ERRBNK DEBR0: LOCKED Position */
        #define ERRBNK_DEBR0_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_DEBR0_LOCKED_Pos) /*!< ERRBNK DEBR0: LOCKED Mask */

        #define ERRBNK_DEBR0_VALID_Pos 0U /*!< ERRBNK DEBR0: VALID Position */
        #define ERRBNK_DEBR0_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_DEBR0_VALID_Pos*/) /*!< ERRBNK DEBR0: VALID Mask */
        ...
        #define ERRBNK_DEBR1_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_DEBR1_SWDEF_Pos) /*!< ERRBNK DEBR1: SWDEF Mask */

        #define ERRBNK_DEBR1_TYPE_Pos 17U /*!< ERRBNK DEBR1: TYPE Position */
        #define ERRBNK_DEBR1_TYPE_Msk                                                              \
            (0x1UL << ERRBNK_DEBR1_TYPE_Pos) /*!< ERRBNK DEBR1: TYPE Mask */

        #define ERRBNK_DEBR1_BANK_Pos 16U /*!< ERRBNK DEBR1: BANK Position */
        #define ERRBNK_DEBR1_BANK_Msk                                                              \
            (0x1UL << ERRBNK_DEBR1_BANK_Pos) /*!< ERRBNK DEBR1: BANK Mask */

        #define ERRBNK_DEBR1_LOCATION_Pos 2U /*!< ERRBNK DEBR1: LOCATION Position */
        #define ERRBNK_DEBR1_LOCATION_Msk                                                          \
            (0x3FFFUL << ERRBNK_DEBR1_LOCATION_Pos) /*!< ERRBNK DEBR1: LOCATION Mask */

        #define ERRBNK_DEBR1_LOCKED_Pos 1U /*!< ERRBNK DEBR1: LOCKED Position */
        #define ERRBNK_DEBR1_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_DEBR1_LOCKED_Pos) /*!< ERRBNK DEBR1: LOCKED Mask */

        #define ERRBNK_DEBR1_VALID_Pos 0U /*!< ERRBNK DEBR1: VALID Position */
        #define ERRBNK_DEBR1_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_DEBR1_VALID_Pos*/) /*!< ERRBNK DEBR1: VALID Mask */

        /* ERRBNK TCM Error Bank Register 0 (TEBR0) Register Definitions */
        #define ERRBNK_TEBR0_SWDEF_Pos 30U /*!< ERRBNK TEBR0: SWDEF Position */
        #define ERRBNK_TEBR0_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_TEBR0_SWDEF_Pos) /*!< ERRBNK TEBR0: SWDEF Mask */

        #define ERRBNK_TEBR0_POISON_Pos 28U /*!< ERRBNK TEBR0: POISON Position */
        #define ERRBNK_TEBR0_POISON_Msk                                                            \
            (0x1UL << ERRBNK_TEBR0_POISON_Pos) /*!< ERRBNK TEBR0: POISON Mask */

        #define ERRBNK_TEBR0_TYPE_Pos 27U /*!< ERRBNK TEBR0: TYPE Position */
        #define ERRBNK_TEBR0_TYPE_Msk                                                              \
            (0x1UL << ERRBNK_TEBR0_TYPE_Pos) /*!< ERRBNK TEBR0: TYPE Mask */

        #define ERRBNK_TEBR0_BANK_Pos 24U /*!< ERRBNK TEBR0: BANK Position */
        #define ERRBNK_TEBR0_BANK_Msk                                                              \
            (0x7UL << ERRBNK_TEBR0_BANK_Pos) /*!< ERRBNK TEBR0: BANK Mask */

        #define ERRBNK_TEBR0_LOCATION_Pos 2U /*!< ERRBNK TEBR0: LOCATION Position */
        #define ERRBNK_TEBR0_LOCATION_Msk                                                          \
            (0x3FFFFFUL << ERRBNK_TEBR0_LOCATION_Pos) /*!< ERRBNK TEBR0: LOCATION Mask */

        #define ERRBNK_TEBR0_LOCKED_Pos 1U /*!< ERRBNK TEBR0: LOCKED Position */
        #define ERRBNK_TEBR0_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_TEBR0_LOCKED_Pos) /*!< ERRBNK TEBR0: LOCKED Mask */

        #define ERRBNK_TEBR0_VALID_Pos 0U /*!< ERRBNK TEBR0: VALID Position */
        #define ERRBNK_TEBR0_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_TEBR0_VALID_Pos*/) /*!< ERRBNK TEBR0: VALID Mask */

        /* ERRBNK TCM Error Bank Register 1 (TEBR1) Register Definitions */
        #define ERRBNK_TEBR1_SWDEF_Pos 30U /*!< ERRBNK TEBR1: SWDEF Position */
        #define ERRBNK_TEBR1_SWDEF_Msk                                                             \
            (0x3UL << ERRBNK_TEBR1_SWDEF_Pos) /*!< ERRBNK TEBR1: SWDEF Mask */

        #define ERRBNK_TEBR1_POISON_Pos 28U /*!< ERRBNK TEBR1: POISON Position */
        #define ERRBNK_TEBR1_POISON_Msk                                                            \
            (0x1UL << ERRBNK_TEBR1_POISON_Pos) /*!< ERRBNK TEBR1: POISON Mask */

        #define ERRBNK_TEBR1_TYPE_Pos 27U /*!< ERRBNK TEBR1: TYPE Position */
        #define ERRBNK_TEBR1_TYPE_Msk                                                              \
            (0x1UL << ERRBNK_TEBR1_TYPE_Pos) /*!< ERRBNK TEBR1: TYPE Mask */

        #define ERRBNK_TEBR1_BANK_Pos 24U /*!< ERRBNK TEBR1: BANK Position */
        #define ERRBNK_TEBR1_BANK_Msk                                                              \
            (0x7UL << ERRBNK_TEBR1_BANK_Pos) /*!< ERRBNK TEBR1: BANK Mask */

        #define ERRBNK_TEBR1_LOCATION_Pos 2U /*!< ERRBNK TEBR1: LOCATION Position */
        #define ERRBNK_TEBR1_LOCATION_Msk                                                          \
            (0x3FFFFFUL << ERRBNK_TEBR1_LOCATION_Pos) /*!< ERRBNK TEBR1: LOCATION Mask */

        #define ERRBNK_TEBR1_LOCKED_Pos 1U /*!< ERRBNK TEBR1: LOCKED Position */
        #define ERRBNK_TEBR1_LOCKED_Msk                                                            \
            (0x1UL << ERRBNK_TEBR1_LOCKED_Pos) /*!< ERRBNK TEBR1: LOCKED Mask */

        #define ERRBNK_TEBR1_VALID_Pos 0U /*!< ERRBNK TEBR1: VALID Position */
        #define ERRBNK_TEBR1_VALID_Msk                                                             \
            (0x1UL << /*ERRBNK_TEBR1_VALID_Pos*/) /*!< ERRBNK TEBR1: VALID Mask */

/*@}*/ /* end of group ErrBnk_Type */

/**
  \ingroup  CMSIS_core_register
  \defgroup PrcCfgInf_Type     Processor Configuration Information Registers (IMPLEMENTATION
  DEFINED) \brief    Type definitions for the Processor Configuration Information Registerss
  (PRCCFGINF)
  @{
 */
 ...
 */
typedef struct {
    __OM uint32_t CFGINFOSEL; /*!< Offset: 0x000 ( /W)  Processor Configuration Information
                                 Selection Register */
    __IM uint32_t CFGINFORD; /*!< Offset: 0x004 (R/ )  Processor Configuration Information Read Data
                                Register */
} PrcCfgInf_Type;
...
typedef struct {
    ...
    __IM uint32_t STLD1MPUOR; /*!< Offset: 0x01C (R/ )  MPU Memory Attributes Register 1 */
        ...
        #define STL_STLIDMPUSR_ADDR_Msk                                                            \
            (0x7FFFFFFUL << STL_STLIDMPUSR_ADDR_Pos) /*!< STL STLIDMPUSR: ADDR Mask */

        #define STL_STLIDMPUSR_INSTR_Pos 2U /*!< STL STLIDMPUSR: INSTR Position */
        #define STL_STLIDMPUSR_INSTR_Msk                                                           \
            (0x1UL << STL_STLIDMPUSR_INSTR_Pos) /*!< STL STLIDMPUSR: INSTR Mask */

        #define STL_STLIDMPUSR_DATA_Pos 1U /*!< STL STLIDMPUSR: DATA Position */
        #define STL_STLIDMPUSR_DATA_Msk                                                            \
            (0x1UL << STL_STLIDMPUSR_DATA_Pos) /*!< STL STLIDMPUSR: DATA Mask */
        ...
        #define STL_STLIMPUOR_HITREGION_Msk                                                        \
            (0xFFUL << STL_STLIMPUOR_HITREGION_Pos) /*!< STL STLIMPUOR: HITREGION Mask */
        ...
        #define STL_STLD0MPUOR_HITREGION_Msk                                                       \
            (0xFFUL << STL_STLD0MPUOR_HITREGION_Pos) /*!< STL STLD0MPUOR: HITREGION Mask */

        #define STL_STLD0MPUOR_ATTR_Pos 0U /*!< STL STLD0MPUOR: ATTR Position */
        #define STL_STLD0MPUOR_ATTR_Msk                                                            \
            (0x1FFUL /*<< STL_STLD0MPUOR_ATTR_Pos*/) /*!< STL STLD0MPUOR: ATTR Mask */
        ...
        #define STL_STLD1MPUOR_HITREGION_Msk                                                       \
            (0xFFUL << STL_STLD1MPUOR_HITREGION_Pos) /*!< STL STLD1MPUOR: HITREGION Mask */

        #define STL_STLD1MPUOR_ATTR_Pos 0U /*!< STL STLD1MPUOR: ATTR Position */
        #define STL_STLD1MPUOR_ATTR_Msk                                                            \
            (0x1FFUL /*<< STL_STLD1MPUOR_ATTR_Pos*/) /*!< STL STLD1MPUOR: ATTR Mask */
...
typedef struct {
    __IOM uint32_t
        EVCNTR[__PMU_NUM_EVENTCNT]; /*!< Offset: 0x0 (R/W)    PMU Event Counter Registers */
    ...
    __IOM uint32_t EVTYPER[__PMU_NUM_EVENTCNT]; /*!< Offset: 0x400 (R/W)  PMU Event Type and Filter
                                                   Registers */
            #if __PMU_NUM_EVENTCNT < 31
    ...
    __IOM uint32_t CIDR3; /*!< Offset: 0xFFC (R/W)  PMU Component Identification Register 3 */
        ...
        /** \brief PMU Event Counter Registers (0-30) Definitions  */
            ...
            #define PMU_EVCNTR_CNT_Msk                                                             \
                (0xFFFFUL /*<< PMU_EVCNTRx_CNT_Pos*/) /*!< PMU EVCNTR: Counter Mask */
        ...
        /** \brief PMU Event Type and Filter Registers (0-30) Definitions  */
            ...
            #define PMU_EVTYPER_EVENTTOCNT_Msk                                                     \
                (0xFFFFUL /*<< EVTYPERx_EVENTTOCNT_Pos*/) /*!< PMU EVTYPER: Event to Count Mask */

        /** \brief PMU Count Enable Set Register Definitions */

            #define PMU_CNTENSET_CNT0_ENABLE_Pos                                                   \
                0U /*!< PMU CNTENSET: Event Counter 0 Enable Set Position */
            #define PMU_CNTENSET_CNT0_ENABLE_Msk                                                   \
                (1UL /*<< PMU_CNTENSET_CNT0_ENABLE_Pos*/) /*!< PMU CNTENSET: Event Counter 0       \
                                                             Enable Set Mask */

            #define PMU_CNTENSET_CNT1_ENABLE_Pos                                                   \
                1U /*!< PMU CNTENSET: Event Counter 1 Enable Set Position */
            #define PMU_CNTENSET_CNT1_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT1_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 1 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT2_ENABLE_Pos                                                   \
                2U /*!< PMU CNTENSET: Event Counter 2 Enable Set Position */
            #define PMU_CNTENSET_CNT2_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT2_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 2 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT3_ENABLE_Pos                                                   \
                3U /*!< PMU CNTENSET: Event Counter 3 Enable Set Position */
            #define PMU_CNTENSET_CNT3_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT3_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 3 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT4_ENABLE_Pos                                                   \
                4U /*!< PMU CNTENSET: Event Counter 4 Enable Set Position */
            #define PMU_CNTENSET_CNT4_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT4_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 4 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT5_ENABLE_Pos                                                   \
                5U /*!< PMU CNTENSET: Event Counter 5 Enable Set Position */
            #define PMU_CNTENSET_CNT5_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT5_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 5 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT6_ENABLE_Pos                                                   \
                6U /*!< PMU CNTENSET: Event Counter 6 Enable Set Position */
            #define PMU_CNTENSET_CNT6_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT6_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 6 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT7_ENABLE_Pos                                                   \
                7U /*!< PMU CNTENSET: Event Counter 7 Enable Set Position */
            #define PMU_CNTENSET_CNT7_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT7_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 7 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT8_ENABLE_Pos                                                   \
                8U /*!< PMU CNTENSET: Event Counter 8 Enable Set Position */
            #define PMU_CNTENSET_CNT8_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT8_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 8 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT9_ENABLE_Pos                                                   \
                9U /*!< PMU CNTENSET: Event Counter 9 Enable Set Position */
            #define PMU_CNTENSET_CNT9_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENSET_CNT9_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 9 Enable    \
                                                         Set Mask */

            #define PMU_CNTENSET_CNT10_ENABLE_Pos                                                  \
                10U /*!< PMU CNTENSET: Event Counter 10 Enable Set Position */
            #define PMU_CNTENSET_CNT10_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT10_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 10 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT11_ENABLE_Pos                                                  \
                11U /*!< PMU CNTENSET: Event Counter 11 Enable Set Position */
            #define PMU_CNTENSET_CNT11_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT11_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 11 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT12_ENABLE_Pos                                                  \
                12U /*!< PMU CNTENSET: Event Counter 12 Enable Set Position */
            #define PMU_CNTENSET_CNT12_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT12_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 12 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT13_ENABLE_Pos                                                  \
                13U /*!< PMU CNTENSET: Event Counter 13 Enable Set Position */
            #define PMU_CNTENSET_CNT13_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT13_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 13 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT14_ENABLE_Pos                                                  \
                14U /*!< PMU CNTENSET: Event Counter 14 Enable Set Position */
            #define PMU_CNTENSET_CNT14_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT14_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 14 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT15_ENABLE_Pos                                                  \
                15U /*!< PMU CNTENSET: Event Counter 15 Enable Set Position */
            #define PMU_CNTENSET_CNT15_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT15_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 15 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT16_ENABLE_Pos                                                  \
                16U /*!< PMU CNTENSET: Event Counter 16 Enable Set Position */
            #define PMU_CNTENSET_CNT16_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT16_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 16 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT17_ENABLE_Pos                                                  \
                17U /*!< PMU CNTENSET: Event Counter 17 Enable Set Position */
            #define PMU_CNTENSET_CNT17_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT17_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 17 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT18_ENABLE_Pos                                                  \
                18U /*!< PMU CNTENSET: Event Counter 18 Enable Set Position */
            #define PMU_CNTENSET_CNT18_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT18_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 18 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT19_ENABLE_Pos                                                  \
                19U /*!< PMU CNTENSET: Event Counter 19 Enable Set Position */
            #define PMU_CNTENSET_CNT19_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT19_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 19 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT20_ENABLE_Pos                                                  \
                20U /*!< PMU CNTENSET: Event Counter 20 Enable Set Position */
            #define PMU_CNTENSET_CNT20_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT20_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 20 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT21_ENABLE_Pos                                                  \
                21U /*!< PMU CNTENSET: Event Counter 21 Enable Set Position */
            #define PMU_CNTENSET_CNT21_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT21_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 21 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT22_ENABLE_Pos                                                  \
                22U /*!< PMU CNTENSET: Event Counter 22 Enable Set Position */
            #define PMU_CNTENSET_CNT22_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT22_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 22 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT23_ENABLE_Pos                                                  \
                23U /*!< PMU CNTENSET: Event Counter 23 Enable Set Position */
            #define PMU_CNTENSET_CNT23_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT23_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 23 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT24_ENABLE_Pos                                                  \
                24U /*!< PMU CNTENSET: Event Counter 24 Enable Set Position */
            #define PMU_CNTENSET_CNT24_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT24_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 24 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT25_ENABLE_Pos                                                  \
                25U /*!< PMU CNTENSET: Event Counter 25 Enable Set Position */
            #define PMU_CNTENSET_CNT25_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT25_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 25 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT26_ENABLE_Pos                                                  \
                26U /*!< PMU CNTENSET: Event Counter 26 Enable Set Position */
            #define PMU_CNTENSET_CNT26_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT26_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 26 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT27_ENABLE_Pos                                                  \
                27U /*!< PMU CNTENSET: Event Counter 27 Enable Set Position */
            #define PMU_CNTENSET_CNT27_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT27_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 27 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT28_ENABLE_Pos                                                  \
                28U /*!< PMU CNTENSET: Event Counter 28 Enable Set Position */
            #define PMU_CNTENSET_CNT28_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT28_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 28 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT29_ENABLE_Pos                                                  \
                29U /*!< PMU CNTENSET: Event Counter 29 Enable Set Position */
            #define PMU_CNTENSET_CNT29_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT29_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 29 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CNT30_ENABLE_Pos                                                  \
                30U /*!< PMU CNTENSET: Event Counter 30 Enable Set Position */
            #define PMU_CNTENSET_CNT30_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CNT30_ENABLE_Pos) /*!< PMU CNTENSET: Event Counter 30 Enable  \
                                                          Set Mask */

            #define PMU_CNTENSET_CCNTR_ENABLE_Pos                                                  \
                31U /*!< PMU CNTENSET: Cycle Counter Enable Set Position */
            #define PMU_CNTENSET_CCNTR_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENSET_CCNTR_ENABLE_Pos) /*!< PMU CNTENSET: Cycle Counter Enable Set \
                                                          Mask */

        /** \brief PMU Count Enable Clear Register Definitions */

            #define PMU_CNTENSET_CNT0_ENABLE_Pos                                                   \
                0U /*!< PMU CNTENCLR: Event Counter 0 Enable Clear Position */
            #define PMU_CNTENCLR_CNT0_ENABLE_Msk                                                   \
                (1UL /*<< PMU_CNTENCLR_CNT0_ENABLE_Pos*/) /*!< PMU CNTENCLR: Event Counter 0       \
                                                             Enable Clear Mask */

            #define PMU_CNTENCLR_CNT1_ENABLE_Pos                                                   \
                1U /*!< PMU CNTENCLR: Event Counter 1 Enable Clear Position */
            #define PMU_CNTENCLR_CNT1_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT1_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 1 Enable    \
                                                         Clear */

            #define PMU_CNTENCLR_CNT2_ENABLE_Pos                                                   \
                2U /*!< PMU CNTENCLR: Event Counter 2 Enable Clear Position */
            #define PMU_CNTENCLR_CNT2_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT2_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 2 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT3_ENABLE_Pos                                                   \
                3U /*!< PMU CNTENCLR: Event Counter 3 Enable Clear Position */
            #define PMU_CNTENCLR_CNT3_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT3_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 3 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT4_ENABLE_Pos                                                   \
                4U /*!< PMU CNTENCLR: Event Counter 4 Enable Clear Position */
            #define PMU_CNTENCLR_CNT4_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT4_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 4 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT5_ENABLE_Pos                                                   \
                5U /*!< PMU CNTENCLR: Event Counter 5 Enable Clear Position */
            #define PMU_CNTENCLR_CNT5_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT5_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 5 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT6_ENABLE_Pos                                                   \
                6U /*!< PMU CNTENCLR: Event Counter 6 Enable Clear Position */
            #define PMU_CNTENCLR_CNT6_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT6_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 6 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT7_ENABLE_Pos                                                   \
                7U /*!< PMU CNTENCLR: Event Counter 7 Enable Clear Position */
            #define PMU_CNTENCLR_CNT7_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT7_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 7 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT8_ENABLE_Pos                                                   \
                8U /*!< PMU CNTENCLR: Event Counter 8 Enable Clear Position */
            #define PMU_CNTENCLR_CNT8_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT8_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 8 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT9_ENABLE_Pos                                                   \
                9U /*!< PMU CNTENCLR: Event Counter 9 Enable Clear Position */
            #define PMU_CNTENCLR_CNT9_ENABLE_Msk                                                   \
                (1UL << PMU_CNTENCLR_CNT9_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 9 Enable    \
                                                         Clear Mask */

            #define PMU_CNTENCLR_CNT10_ENABLE_Pos                                                  \
                10U /*!< PMU CNTENCLR: Event Counter 10 Enable Clear Position */
            #define PMU_CNTENCLR_CNT10_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT10_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 10 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT11_ENABLE_Pos                                                  \
                11U /*!< PMU CNTENCLR: Event Counter 11 Enable Clear Position */
            #define PMU_CNTENCLR_CNT11_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT11_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 11 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT12_ENABLE_Pos                                                  \
                12U /*!< PMU CNTENCLR: Event Counter 12 Enable Clear Position */
            #define PMU_CNTENCLR_CNT12_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT12_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 12 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT13_ENABLE_Pos                                                  \
                13U /*!< PMU CNTENCLR: Event Counter 13 Enable Clear Position */
            #define PMU_CNTENCLR_CNT13_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT13_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 13 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT14_ENABLE_Pos                                                  \
                14U /*!< PMU CNTENCLR: Event Counter 14 Enable Clear Position */
            #define PMU_CNTENCLR_CNT14_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT14_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 14 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT15_ENABLE_Pos                                                  \
                15U /*!< PMU CNTENCLR: Event Counter 15 Enable Clear Position */
            #define PMU_CNTENCLR_CNT15_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT15_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 15 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT16_ENABLE_Pos                                                  \
                16U /*!< PMU CNTENCLR: Event Counter 16 Enable Clear Position */
            #define PMU_CNTENCLR_CNT16_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT16_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 16 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT17_ENABLE_Pos                                                  \
                17U /*!< PMU CNTENCLR: Event Counter 17 Enable Clear Position */
            #define PMU_CNTENCLR_CNT17_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT17_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 17 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT18_ENABLE_Pos                                                  \
                18U /*!< PMU CNTENCLR: Event Counter 18 Enable Clear Position */
            #define PMU_CNTENCLR_CNT18_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT18_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 18 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT19_ENABLE_Pos                                                  \
                19U /*!< PMU CNTENCLR: Event Counter 19 Enable Clear Position */
            #define PMU_CNTENCLR_CNT19_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT19_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 19 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT20_ENABLE_Pos                                                  \
                20U /*!< PMU CNTENCLR: Event Counter 20 Enable Clear Position */
            #define PMU_CNTENCLR_CNT20_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT20_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 20 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT21_ENABLE_Pos                                                  \
                21U /*!< PMU CNTENCLR: Event Counter 21 Enable Clear Position */
            #define PMU_CNTENCLR_CNT21_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT21_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 21 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT22_ENABLE_Pos                                                  \
                22U /*!< PMU CNTENCLR: Event Counter 22 Enable Clear Position */
            #define PMU_CNTENCLR_CNT22_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT22_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 22 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT23_ENABLE_Pos                                                  \
                23U /*!< PMU CNTENCLR: Event Counter 23 Enable Clear Position */
            #define PMU_CNTENCLR_CNT23_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT23_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 23 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT24_ENABLE_Pos                                                  \
                24U /*!< PMU CNTENCLR: Event Counter 24 Enable Clear Position */
            #define PMU_CNTENCLR_CNT24_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT24_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 24 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT25_ENABLE_Pos                                                  \
                25U /*!< PMU CNTENCLR: Event Counter 25 Enable Clear Position */
            #define PMU_CNTENCLR_CNT25_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT25_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 25 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT26_ENABLE_Pos                                                  \
                26U /*!< PMU CNTENCLR: Event Counter 26 Enable Clear Position */
            #define PMU_CNTENCLR_CNT26_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT26_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 26 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT27_ENABLE_Pos                                                  \
                27U /*!< PMU CNTENCLR: Event Counter 27 Enable Clear Position */
            #define PMU_CNTENCLR_CNT27_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT27_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 27 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT28_ENABLE_Pos                                                  \
                28U /*!< PMU CNTENCLR: Event Counter 28 Enable Clear Position */
            #define PMU_CNTENCLR_CNT28_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT28_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 28 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT29_ENABLE_Pos                                                  \
                29U /*!< PMU CNTENCLR: Event Counter 29 Enable Clear Position */
            #define PMU_CNTENCLR_CNT29_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT29_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 29 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CNT30_ENABLE_Pos                                                  \
                30U /*!< PMU CNTENCLR: Event Counter 30 Enable Clear Position */
            #define PMU_CNTENCLR_CNT30_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CNT30_ENABLE_Pos) /*!< PMU CNTENCLR: Event Counter 30 Enable  \
                                                          Clear Mask */

            #define PMU_CNTENCLR_CCNTR_ENABLE_Pos                                                  \
                31U /*!< PMU CNTENCLR: Cycle Counter Enable Clear Position */
            #define PMU_CNTENCLR_CCNTR_ENABLE_Msk                                                  \
                (1UL << PMU_CNTENCLR_CCNTR_ENABLE_Pos) /*!< PMU CNTENCLR: Cycle Counter Enable     \
                                                          Clear Mask */

        /** \brief PMU Interrupt Enable Set Register Definitions */

            #define PMU_INTENSET_CNT0_ENABLE_Pos                                                   \
                0U /*!< PMU INTENSET: Event Counter 0 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT0_ENABLE_Msk                                                   \
                (1UL /*<< PMU_INTENSET_CNT0_ENABLE_Pos*/) /*!< PMU INTENSET: Event Counter 0       \
                                                             Interrupt Enable Set Mask */

            #define PMU_INTENSET_CNT1_ENABLE_Pos                                                   \
                1U /*!< PMU INTENSET: Event Counter 1 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT1_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT1_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 1 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT2_ENABLE_Pos                                                   \
                2U /*!< PMU INTENSET: Event Counter 2 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT2_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT2_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 2 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT3_ENABLE_Pos                                                   \
                3U /*!< PMU INTENSET: Event Counter 3 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT3_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT3_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 3 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT4_ENABLE_Pos                                                   \
                4U /*!< PMU INTENSET: Event Counter 4 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT4_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT4_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 4 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT5_ENABLE_Pos                                                   \
                5U /*!< PMU INTENSET: Event Counter 5 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT5_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT5_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 5 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT6_ENABLE_Pos                                                   \
                6U /*!< PMU INTENSET: Event Counter 6 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT6_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT6_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 6 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT7_ENABLE_Pos                                                   \
                7U /*!< PMU INTENSET: Event Counter 7 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT7_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT7_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 7 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT8_ENABLE_Pos                                                   \
                8U /*!< PMU INTENSET: Event Counter 8 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT8_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT8_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 8 Interrupt \
                                                         Enable Set Mask */

            #define PMU_INTENSET_CNT9_ENABLE_Pos                                                   \
                9U /*!< PMU INTENSET: Event Counter 9 Interrupt Enable Set Position */
            #define PMU_INTENSET_CNT9_ENABLE_Msk                                                   \
                (1UL << PMU_INTENSET_CNT9_ENABLE_Pos) /*!< PMU INTENSET: Event Counter 9 Interrupt \
                                                         Enable Set Mask */
            ...
            #define PMU_INTENSET_CYCCNT_ENABLE_Pos                                                 \
                31U /*!< PMU INTENSET: Cycle Counter Interrupt Enable Set Position */
            #define PMU_INTENSET_CCYCNT_ENABLE_Msk                                                 \
                (1UL << PMU_INTENSET_CYCCNT_ENABLE_Pos) /*!< PMU INTENSET: Cycle Counter Interrupt \
                                                           Enable Set Mask */
        ...
        /** \brief PMU Interrupt Enable Clear Register Definitions */
            ...
            #define PMU_INTENCLR_CNT0_ENABLE_Msk                                                   \
                (1UL /*<< PMU_INTENCLR_CNT0_ENABLE_Pos*/) /*!< PMU INTENCLR: Event Counter 0       \
            ...
            #define PMU_INTENCLR_CNT1_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT1_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 1 Interrupt \
                                                         Enable Clear */
            ...
            #define PMU_INTENCLR_CNT2_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT2_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 2 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT3_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT3_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 3 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT4_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT4_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 4 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT5_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT5_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 5 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT6_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT6_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 6 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT7_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT7_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 7 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT8_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT8_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 8 Interrupt \
                                                         Enable Clear Mask */
            ...
            #define PMU_INTENCLR_CNT9_ENABLE_Msk                                                   \
                (1UL << PMU_INTENCLR_CNT9_ENABLE_Pos) /*!< PMU INTENCLR: Event Counter 9 Interrupt \
                                                         Enable Clear Mask */

            #define PMU_INTENCLR_CNT10_ENABLE_Pos                                                  \
                10U /*!< PMU INTENCLR: Event Counter 10 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT11_ENABLE_Pos                                                  \
                11U /*!< PMU INTENCLR: Event Counter 11 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT12_ENABLE_Pos                                                  \
                12U /*!< PMU INTENCLR: Event Counter 12 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT13_ENABLE_Pos                                                  \
                13U /*!< PMU INTENCLR: Event Counter 13 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT14_ENABLE_Pos                                                  \
                14U /*!< PMU INTENCLR: Event Counter 14 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT15_ENABLE_Pos                                                  \
                15U /*!< PMU INTENCLR: Event Counter 15 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT16_ENABLE_Pos                                                  \
                16U /*!< PMU INTENCLR: Event Counter 16 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT17_ENABLE_Pos                                                  \
                17U /*!< PMU INTENCLR: Event Counter 17 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT18_ENABLE_Pos                                                  \
                18U /*!< PMU INTENCLR: Event Counter 18 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT19_ENABLE_Pos                                                  \
                19U /*!< PMU INTENCLR: Event Counter 19 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT20_ENABLE_Pos                                                  \
                20U /*!< PMU INTENCLR: Event Counter 20 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT21_ENABLE_Pos                                                  \
                21U /*!< PMU INTENCLR: Event Counter 21 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT22_ENABLE_Pos                                                  \
                22U /*!< PMU INTENCLR: Event Counter 22 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT23_ENABLE_Pos                                                  \
                23U /*!< PMU INTENCLR: Event Counter 23 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT24_ENABLE_Pos                                                  \
                24U /*!< PMU INTENCLR: Event Counter 24 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT25_ENABLE_Pos                                                  \
                25U /*!< PMU INTENCLR: Event Counter 25 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT26_ENABLE_Pos                                                  \
                26U /*!< PMU INTENCLR: Event Counter 26 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT27_ENABLE_Pos                                                  \
                27U /*!< PMU INTENCLR: Event Counter 27 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT28_ENABLE_Pos                                                  \
                28U /*!< PMU INTENCLR: Event Counter 28 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT29_ENABLE_Pos                                                  \
                29U /*!< PMU INTENCLR: Event Counter 29 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CNT30_ENABLE_Pos                                                  \
                30U /*!< PMU INTENCLR: Event Counter 30 Interrupt Enable Clear Position */
            ...
            #define PMU_INTENCLR_CYCCNT_ENABLE_Msk                                                 \
                (1UL << PMU_INTENCLR_CYCCNT_ENABLE_Pos) /*!< PMU INTENCLR: Cycle Counter Interrupt \
                                                           Enable Clear Mask */

        /** \brief PMU Overflow Flag Status Set Register Definitions */

            #define PMU_OVSSET_CNT0_STATUS_Pos                                                     \
                0U /*!< PMU OVSSET: Event Counter 0 Overflow Set Position */
            #define PMU_OVSSET_CNT0_STATUS_Msk                                                     \
                (1UL /*<< PMU_OVSSET_CNT0_STATUS_Pos*/) /*!< PMU OVSSET: Event Counter 0 Overflow  \
                                                           Set Mask */

            #define PMU_OVSSET_CNT1_STATUS_Pos                                                     \
                1U /*!< PMU OVSSET: Event Counter 1 Overflow Set Position */
            #define PMU_OVSSET_CNT1_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT1_STATUS_Pos) /*!< PMU OVSSET: Event Counter 1 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT2_STATUS_Pos                                                     \
                2U /*!< PMU OVSSET: Event Counter 2 Overflow Set Position */
            #define PMU_OVSSET_CNT2_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT2_STATUS_Pos) /*!< PMU OVSSET: Event Counter 2 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT3_STATUS_Pos                                                     \
                3U /*!< PMU OVSSET: Event Counter 3 Overflow Set Position */
            #define PMU_OVSSET_CNT3_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT3_STATUS_Pos) /*!< PMU OVSSET: Event Counter 3 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT4_STATUS_Pos                                                     \
                4U /*!< PMU OVSSET: Event Counter 4 Overflow Set Position */
            #define PMU_OVSSET_CNT4_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT4_STATUS_Pos) /*!< PMU OVSSET: Event Counter 4 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT5_STATUS_Pos                                                     \
                5U /*!< PMU OVSSET: Event Counter 5 Overflow Set Position */
            #define PMU_OVSSET_CNT5_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT5_STATUS_Pos) /*!< PMU OVSSET: Event Counter 5 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT6_STATUS_Pos                                                     \
                6U /*!< PMU OVSSET: Event Counter 6 Overflow Set Position */
            #define PMU_OVSSET_CNT6_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT6_STATUS_Pos) /*!< PMU OVSSET: Event Counter 6 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT7_STATUS_Pos                                                     \
                7U /*!< PMU OVSSET: Event Counter 7 Overflow Set Position */
            #define PMU_OVSSET_CNT7_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT7_STATUS_Pos) /*!< PMU OVSSET: Event Counter 7 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT8_STATUS_Pos                                                     \
                8U /*!< PMU OVSSET: Event Counter 8 Overflow Set Position */
            #define PMU_OVSSET_CNT8_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT8_STATUS_Pos) /*!< PMU OVSSET: Event Counter 8 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT9_STATUS_Pos                                                     \
                9U /*!< PMU OVSSET: Event Counter 9 Overflow Set Position */
            #define PMU_OVSSET_CNT9_STATUS_Msk                                                     \
                (1UL << PMU_OVSSET_CNT9_STATUS_Pos) /*!< PMU OVSSET: Event Counter 9 Overflow Set  \
                                                       Mask */

            #define PMU_OVSSET_CNT10_STATUS_Pos                                                    \
                10U /*!< PMU OVSSET: Event Counter 10 Overflow Set Position */
            #define PMU_OVSSET_CNT10_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT10_STATUS_Pos) /*!< PMU OVSSET: Event Counter 10 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT11_STATUS_Pos                                                    \
                11U /*!< PMU OVSSET: Event Counter 11 Overflow Set Position */
            #define PMU_OVSSET_CNT11_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT11_STATUS_Pos) /*!< PMU OVSSET: Event Counter 11 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT12_STATUS_Pos                                                    \
                12U /*!< PMU OVSSET: Event Counter 12 Overflow Set Position */
            #define PMU_OVSSET_CNT12_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT12_STATUS_Pos) /*!< PMU OVSSET: Event Counter 12 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT13_STATUS_Pos                                                    \
                13U /*!< PMU OVSSET: Event Counter 13 Overflow Set Position */
            #define PMU_OVSSET_CNT13_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT13_STATUS_Pos) /*!< PMU OVSSET: Event Counter 13 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT14_STATUS_Pos                                                    \
                14U /*!< PMU OVSSET: Event Counter 14 Overflow Set Position */
            #define PMU_OVSSET_CNT14_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT14_STATUS_Pos) /*!< PMU OVSSET: Event Counter 14 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT15_STATUS_Pos                                                    \
                15U /*!< PMU OVSSET: Event Counter 15 Overflow Set Position */
            #define PMU_OVSSET_CNT15_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT15_STATUS_Pos) /*!< PMU OVSSET: Event Counter 15 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT16_STATUS_Pos                                                    \
                16U /*!< PMU OVSSET: Event Counter 16 Overflow Set Position */
            #define PMU_OVSSET_CNT16_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT16_STATUS_Pos) /*!< PMU OVSSET: Event Counter 16 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT17_STATUS_Pos                                                    \
                17U /*!< PMU OVSSET: Event Counter 17 Overflow Set Position */
            #define PMU_OVSSET_CNT17_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT17_STATUS_Pos) /*!< PMU OVSSET: Event Counter 17 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT18_STATUS_Pos                                                    \
                18U /*!< PMU OVSSET: Event Counter 18 Overflow Set Position */
            #define PMU_OVSSET_CNT18_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT18_STATUS_Pos) /*!< PMU OVSSET: Event Counter 18 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT19_STATUS_Pos                                                    \
                19U /*!< PMU OVSSET: Event Counter 19 Overflow Set Position */
            #define PMU_OVSSET_CNT19_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT19_STATUS_Pos) /*!< PMU OVSSET: Event Counter 19 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT20_STATUS_Pos                                                    \
                20U /*!< PMU OVSSET: Event Counter 20 Overflow Set Position */
            #define PMU_OVSSET_CNT20_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT20_STATUS_Pos) /*!< PMU OVSSET: Event Counter 20 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT21_STATUS_Pos                                                    \
                21U /*!< PMU OVSSET: Event Counter 21 Overflow Set Position */
            #define PMU_OVSSET_CNT21_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT21_STATUS_Pos) /*!< PMU OVSSET: Event Counter 21 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT22_STATUS_Pos                                                    \
                22U /*!< PMU OVSSET: Event Counter 22 Overflow Set Position */
            #define PMU_OVSSET_CNT22_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT22_STATUS_Pos) /*!< PMU OVSSET: Event Counter 22 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT23_STATUS_Pos                                                    \
                23U /*!< PMU OVSSET: Event Counter 23 Overflow Set Position */
            #define PMU_OVSSET_CNT23_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT23_STATUS_Pos) /*!< PMU OVSSET: Event Counter 23 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT24_STATUS_Pos                                                    \
                24U /*!< PMU OVSSET: Event Counter 24 Overflow Set Position */
            #define PMU_OVSSET_CNT24_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT24_STATUS_Pos) /*!< PMU OVSSET: Event Counter 24 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT25_STATUS_Pos                                                    \
                25U /*!< PMU OVSSET: Event Counter 25 Overflow Set Position */
            #define PMU_OVSSET_CNT25_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT25_STATUS_Pos) /*!< PMU OVSSET: Event Counter 25 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT26_STATUS_Pos                                                    \
                26U /*!< PMU OVSSET: Event Counter 26 Overflow Set Position */
            #define PMU_OVSSET_CNT26_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT26_STATUS_Pos) /*!< PMU OVSSET: Event Counter 26 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT27_STATUS_Pos                                                    \
                27U /*!< PMU OVSSET: Event Counter 27 Overflow Set Position */
            #define PMU_OVSSET_CNT27_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT27_STATUS_Pos) /*!< PMU OVSSET: Event Counter 27 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT28_STATUS_Pos                                                    \
                28U /*!< PMU OVSSET: Event Counter 28 Overflow Set Position */
            #define PMU_OVSSET_CNT28_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT28_STATUS_Pos) /*!< PMU OVSSET: Event Counter 28 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT29_STATUS_Pos                                                    \
                29U /*!< PMU OVSSET: Event Counter 29 Overflow Set Position */
            #define PMU_OVSSET_CNT29_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT29_STATUS_Pos) /*!< PMU OVSSET: Event Counter 29 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CNT30_STATUS_Pos                                                    \
                30U /*!< PMU OVSSET: Event Counter 30 Overflow Set Position */
            #define PMU_OVSSET_CNT30_STATUS_Msk                                                    \
                (1UL << PMU_OVSSET_CNT30_STATUS_Pos) /*!< PMU OVSSET: Event Counter 30 Overflow    \
                                                        Set Mask */

            #define PMU_OVSSET_CYCCNT_STATUS_Pos                                                   \
                31U /*!< PMU OVSSET: Cycle Counter Overflow Set Position */
            #define PMU_OVSSET_CYCCNT_STATUS_Msk                                                   \
                (1UL << PMU_OVSSET_CYCCNT_STATUS_Pos) /*!< PMU OVSSET: Cycle Counter Overflow Set  \
                                                         Mask */

        /** \brief PMU Overflow Flag Status Clear Register Definitions */

            #define PMU_OVSCLR_CNT0_STATUS_Pos                                                     \
                0U /*!< PMU OVSCLR: Event Counter 0 Overflow Clear Position */
            #define PMU_OVSCLR_CNT0_STATUS_Msk                                                     \
                (1UL /*<< PMU_OVSCLR_CNT0_STATUS_Pos*/) /*!< PMU OVSCLR: Event Counter 0 Overflow  \
                                                           Clear Mask */

            #define PMU_OVSCLR_CNT1_STATUS_Pos                                                     \
                1U /*!< PMU OVSCLR: Event Counter 1 Overflow Clear Position */
            #define PMU_OVSCLR_CNT1_STATUS_Msk                                                     \
                (1UL                                                                               \
                 << PMU_OVSCLR_CNT1_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 1 Overflow Clear */

            #define PMU_OVSCLR_CNT2_STATUS_Pos                                                     \
                2U /*!< PMU OVSCLR: Event Counter 2 Overflow Clear Position */
            #define PMU_OVSCLR_CNT2_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT2_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 2 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT3_STATUS_Pos                                                     \
                3U /*!< PMU OVSCLR: Event Counter 3 Overflow Clear Position */
            #define PMU_OVSCLR_CNT3_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT3_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 3 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT4_STATUS_Pos                                                     \
                4U /*!< PMU OVSCLR: Event Counter 4 Overflow Clear Position */
            #define PMU_OVSCLR_CNT4_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT4_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 4 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT5_STATUS_Pos                                                     \
                5U /*!< PMU OVSCLR: Event Counter 5 Overflow Clear Position */
            #define PMU_OVSCLR_CNT5_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT5_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 5 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT6_STATUS_Pos                                                     \
                6U /*!< PMU OVSCLR: Event Counter 6 Overflow Clear Position */
            #define PMU_OVSCLR_CNT6_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT6_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 6 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT7_STATUS_Pos                                                     \
                7U /*!< PMU OVSCLR: Event Counter 7 Overflow Clear Position */
            #define PMU_OVSCLR_CNT7_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT7_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 7 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT8_STATUS_Pos                                                     \
                8U /*!< PMU OVSCLR: Event Counter 8 Overflow Clear Position */
            #define PMU_OVSCLR_CNT8_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT8_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 8 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT9_STATUS_Pos                                                     \
                9U /*!< PMU OVSCLR: Event Counter 9 Overflow Clear Position */
            #define PMU_OVSCLR_CNT9_STATUS_Msk                                                     \
                (1UL << PMU_OVSCLR_CNT9_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 9 Overflow      \
                                                       Clear Mask */

            #define PMU_OVSCLR_CNT10_STATUS_Pos                                                    \
                10U /*!< PMU OVSCLR: Event Counter 10 Overflow Clear Position */
            #define PMU_OVSCLR_CNT10_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT10_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 10 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT11_STATUS_Pos                                                    \
                11U /*!< PMU OVSCLR: Event Counter 11 Overflow Clear Position */
            #define PMU_OVSCLR_CNT11_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT11_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 11 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT12_STATUS_Pos                                                    \
                12U /*!< PMU OVSCLR: Event Counter 12 Overflow Clear Position */
            #define PMU_OVSCLR_CNT12_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT12_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 12 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT13_STATUS_Pos                                                    \
                13U /*!< PMU OVSCLR: Event Counter 13 Overflow Clear Position */
            #define PMU_OVSCLR_CNT13_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT13_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 13 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT14_STATUS_Pos                                                    \
                14U /*!< PMU OVSCLR: Event Counter 14 Overflow Clear Position */
            #define PMU_OVSCLR_CNT14_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT14_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 14 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT15_STATUS_Pos                                                    \
                15U /*!< PMU OVSCLR: Event Counter 15 Overflow Clear Position */
            #define PMU_OVSCLR_CNT15_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT15_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 15 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT16_STATUS_Pos                                                    \
                16U /*!< PMU OVSCLR: Event Counter 16 Overflow Clear Position */
            #define PMU_OVSCLR_CNT16_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT16_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 16 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT17_STATUS_Pos                                                    \
                17U /*!< PMU OVSCLR: Event Counter 17 Overflow Clear Position */
            #define PMU_OVSCLR_CNT17_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT17_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 17 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT18_STATUS_Pos                                                    \
                18U /*!< PMU OVSCLR: Event Counter 18 Overflow Clear Position */
            #define PMU_OVSCLR_CNT18_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT18_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 18 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT19_STATUS_Pos                                                    \
                19U /*!< PMU OVSCLR: Event Counter 19 Overflow Clear Position */
            #define PMU_OVSCLR_CNT19_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT19_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 19 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT20_STATUS_Pos                                                    \
                20U /*!< PMU OVSCLR: Event Counter 20 Overflow Clear Position */
            #define PMU_OVSCLR_CNT20_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT20_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 20 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT21_STATUS_Pos                                                    \
                21U /*!< PMU OVSCLR: Event Counter 21 Overflow Clear Position */
            #define PMU_OVSCLR_CNT21_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT21_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 21 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT22_STATUS_Pos                                                    \
                22U /*!< PMU OVSCLR: Event Counter 22 Overflow Clear Position */
            #define PMU_OVSCLR_CNT22_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT22_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 22 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT23_STATUS_Pos                                                    \
                23U /*!< PMU OVSCLR: Event Counter 23 Overflow Clear Position */
            #define PMU_OVSCLR_CNT23_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT23_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 23 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT24_STATUS_Pos                                                    \
                24U /*!< PMU OVSCLR: Event Counter 24 Overflow Clear Position */
            #define PMU_OVSCLR_CNT24_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT24_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 24 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT25_STATUS_Pos                                                    \
                25U /*!< PMU OVSCLR: Event Counter 25 Overflow Clear Position */
            #define PMU_OVSCLR_CNT25_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT25_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 25 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT26_STATUS_Pos                                                    \
                26U /*!< PMU OVSCLR: Event Counter 26 Overflow Clear Position */
            #define PMU_OVSCLR_CNT26_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT26_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 26 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT27_STATUS_Pos                                                    \
                27U /*!< PMU OVSCLR: Event Counter 27 Overflow Clear Position */
            #define PMU_OVSCLR_CNT27_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT27_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 27 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT28_STATUS_Pos                                                    \
                28U /*!< PMU OVSCLR: Event Counter 28 Overflow Clear Position */
            #define PMU_OVSCLR_CNT28_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT28_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 28 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT29_STATUS_Pos                                                    \
                29U /*!< PMU OVSCLR: Event Counter 29 Overflow Clear Position */
            #define PMU_OVSCLR_CNT29_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT29_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 29 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CNT30_STATUS_Pos                                                    \
                30U /*!< PMU OVSCLR: Event Counter 30 Overflow Clear Position */
            #define PMU_OVSCLR_CNT30_STATUS_Msk                                                    \
                (1UL << PMU_OVSCLR_CNT30_STATUS_Pos) /*!< PMU OVSCLR: Event Counter 30 Overflow    \
                                                        Clear Mask */

            #define PMU_OVSCLR_CYCCNT_STATUS_Pos                                                   \
                31U /*!< PMU OVSCLR: Cycle Counter Overflow Clear Position */
            #define PMU_OVSCLR_CYCCNT_STATUS_Msk                                                   \
                (1UL << PMU_OVSCLR_CYCCNT_STATUS_Pos) /*!< PMU OVSCLR: Cycle Counter Overflow      \
                                                         Clear Mask */

        /** \brief PMU Software Increment Counter */

            #define PMU_SWINC_CNT0_Pos                                                             \
                0U /*!< PMU SWINC: Event Counter 0 Software Increment Position */
            #define PMU_SWINC_CNT0_Msk                                                             \
                (1UL /*<< PMU_SWINC_CNT0_Pos */) /*!< PMU SWINC: Event Counter 0 Software          \
                                                    Increment Mask */

            #define PMU_SWINC_CNT1_Pos                                                             \
                1U /*!< PMU SWINC: Event Counter 1 Software Increment Position */
            #define PMU_SWINC_CNT1_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT1_Pos) /*!< PMU SWINC: Event Counter 1 Software Increment Mask */

            #define PMU_SWINC_CNT2_Pos                                                             \
                2U /*!< PMU SWINC: Event Counter 2 Software Increment Position */
            #define PMU_SWINC_CNT2_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT2_Pos) /*!< PMU SWINC: Event Counter 2 Software Increment Mask */

            #define PMU_SWINC_CNT3_Pos                                                             \
                3U /*!< PMU SWINC: Event Counter 3 Software Increment Position */
            #define PMU_SWINC_CNT3_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT3_Pos) /*!< PMU SWINC: Event Counter 3 Software Increment Mask */

            #define PMU_SWINC_CNT4_Pos                                                             \
                4U /*!< PMU SWINC: Event Counter 4 Software Increment Position */
            #define PMU_SWINC_CNT4_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT4_Pos) /*!< PMU SWINC: Event Counter 4 Software Increment Mask */

            #define PMU_SWINC_CNT5_Pos                                                             \
                5U /*!< PMU SWINC: Event Counter 5 Software Increment Position */
            #define PMU_SWINC_CNT5_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT5_Pos) /*!< PMU SWINC: Event Counter 5 Software Increment Mask */

            #define PMU_SWINC_CNT6_Pos                                                             \
                6U /*!< PMU SWINC: Event Counter 6 Software Increment Position */
            #define PMU_SWINC_CNT6_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT6_Pos) /*!< PMU SWINC: Event Counter 6 Software Increment Mask */

            #define PMU_SWINC_CNT7_Pos                                                             \
                7U /*!< PMU SWINC: Event Counter 7 Software Increment Position */
            #define PMU_SWINC_CNT7_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT7_Pos) /*!< PMU SWINC: Event Counter 7 Software Increment Mask */

            #define PMU_SWINC_CNT8_Pos                                                             \
                8U /*!< PMU SWINC: Event Counter 8 Software Increment Position */
            #define PMU_SWINC_CNT8_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT8_Pos) /*!< PMU SWINC: Event Counter 8 Software Increment Mask */

            #define PMU_SWINC_CNT9_Pos                                                             \
                9U /*!< PMU SWINC: Event Counter 9 Software Increment Position */
            #define PMU_SWINC_CNT9_Msk                                                             \
                (1UL                                                                               \
                 << PMU_SWINC_CNT9_Pos) /*!< PMU SWINC: Event Counter 9 Software Increment Mask */

            #define PMU_SWINC_CNT10_Pos                                                            \
                10U /*!< PMU SWINC: Event Counter 10 Software Increment Position */
            #define PMU_SWINC_CNT10_Msk                                                            \
                (1UL << PMU_SWINC_CNT10_Pos) /*!< PMU SWINC: Event Counter 10 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT11_Pos                                                            \
                11U /*!< PMU SWINC: Event Counter 11 Software Increment Position */
            #define PMU_SWINC_CNT11_Msk                                                            \
                (1UL << PMU_SWINC_CNT11_Pos) /*!< PMU SWINC: Event Counter 11 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT12_Pos                                                            \
                12U /*!< PMU SWINC: Event Counter 12 Software Increment Position */
            #define PMU_SWINC_CNT12_Msk                                                            \
                (1UL << PMU_SWINC_CNT12_Pos) /*!< PMU SWINC: Event Counter 12 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT13_Pos                                                            \
                13U /*!< PMU SWINC: Event Counter 13 Software Increment Position */
            #define PMU_SWINC_CNT13_Msk                                                            \
                (1UL << PMU_SWINC_CNT13_Pos) /*!< PMU SWINC: Event Counter 13 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT14_Pos                                                            \
                14U /*!< PMU SWINC: Event Counter 14 Software Increment Position */
            #define PMU_SWINC_CNT14_Msk                                                            \
                (1UL << PMU_SWINC_CNT14_Pos) /*!< PMU SWINC: Event Counter 14 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT15_Pos                                                            \
                15U /*!< PMU SWINC: Event Counter 15 Software Increment Position */
            #define PMU_SWINC_CNT15_Msk                                                            \
                (1UL << PMU_SWINC_CNT15_Pos) /*!< PMU SWINC: Event Counter 15 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT16_Pos                                                            \
                16U /*!< PMU SWINC: Event Counter 16 Software Increment Position */
            #define PMU_SWINC_CNT16_Msk                                                            \
                (1UL << PMU_SWINC_CNT16_Pos) /*!< PMU SWINC: Event Counter 16 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT17_Pos                                                            \
                17U /*!< PMU SWINC: Event Counter 17 Software Increment Position */
            #define PMU_SWINC_CNT17_Msk                                                            \
                (1UL << PMU_SWINC_CNT17_Pos) /*!< PMU SWINC: Event Counter 17 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT18_Pos                                                            \
                18U /*!< PMU SWINC: Event Counter 18 Software Increment Position */
            #define PMU_SWINC_CNT18_Msk                                                            \
                (1UL << PMU_SWINC_CNT18_Pos) /*!< PMU SWINC: Event Counter 18 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT19_Pos                                                            \
                19U /*!< PMU SWINC: Event Counter 19 Software Increment Position */
            #define PMU_SWINC_CNT19_Msk                                                            \
                (1UL << PMU_SWINC_CNT19_Pos) /*!< PMU SWINC: Event Counter 19 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT20_Pos                                                            \
                20U /*!< PMU SWINC: Event Counter 20 Software Increment Position */
            #define PMU_SWINC_CNT20_Msk                                                            \
                (1UL << PMU_SWINC_CNT20_Pos) /*!< PMU SWINC: Event Counter 20 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT21_Pos                                                            \
                21U /*!< PMU SWINC: Event Counter 21 Software Increment Position */
            #define PMU_SWINC_CNT21_Msk                                                            \
                (1UL << PMU_SWINC_CNT21_Pos) /*!< PMU SWINC: Event Counter 21 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT22_Pos                                                            \
                22U /*!< PMU SWINC: Event Counter 22 Software Increment Position */
            #define PMU_SWINC_CNT22_Msk                                                            \
                (1UL << PMU_SWINC_CNT22_Pos) /*!< PMU SWINC: Event Counter 22 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT23_Pos                                                            \
                23U /*!< PMU SWINC: Event Counter 23 Software Increment Position */
            #define PMU_SWINC_CNT23_Msk                                                            \
                (1UL << PMU_SWINC_CNT23_Pos) /*!< PMU SWINC: Event Counter 23 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT24_Pos                                                            \
                24U /*!< PMU SWINC: Event Counter 24 Software Increment Position */
            #define PMU_SWINC_CNT24_Msk                                                            \
                (1UL << PMU_SWINC_CNT24_Pos) /*!< PMU SWINC: Event Counter 24 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT25_Pos                                                            \
                25U /*!< PMU SWINC: Event Counter 25 Software Increment Position */
            #define PMU_SWINC_CNT25_Msk                                                            \
                (1UL << PMU_SWINC_CNT25_Pos) /*!< PMU SWINC: Event Counter 25 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT26_Pos                                                            \
                26U /*!< PMU SWINC: Event Counter 26 Software Increment Position */
            #define PMU_SWINC_CNT26_Msk                                                            \
                (1UL << PMU_SWINC_CNT26_Pos) /*!< PMU SWINC: Event Counter 26 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT27_Pos                                                            \
                27U /*!< PMU SWINC: Event Counter 27 Software Increment Position */
            #define PMU_SWINC_CNT27_Msk                                                            \
                (1UL << PMU_SWINC_CNT27_Pos) /*!< PMU SWINC: Event Counter 27 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT28_Pos                                                            \
                28U /*!< PMU SWINC: Event Counter 28 Software Increment Position */
            #define PMU_SWINC_CNT28_Msk                                                            \
                (1UL << PMU_SWINC_CNT28_Pos) /*!< PMU SWINC: Event Counter 28 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT29_Pos                                                            \
                29U /*!< PMU SWINC: Event Counter 29 Software Increment Position */
            #define PMU_SWINC_CNT29_Msk                                                            \
                (1UL << PMU_SWINC_CNT29_Pos) /*!< PMU SWINC: Event Counter 29 Software Increment   \
                                                Mask */

            #define PMU_SWINC_CNT30_Pos                                                            \
                30U /*!< PMU SWINC: Event Counter 30 Software Increment Position */
            #define PMU_SWINC_CNT30_Msk                                                            \
                (1UL << PMU_SWINC_CNT30_Pos) /*!< PMU SWINC: Event Counter 30 Software Increment   \
                                                Mask */

        /** \brief PMU Control Register Definitions */

            #define PMU_CTRL_ENABLE_Pos 0U /*!< PMU CTRL: ENABLE Position */
            #define PMU_CTRL_ENABLE_Msk                                                            \
                (1UL /*<< PMU_CTRL_ENABLE_Pos*/) /*!< PMU CTRL: ENABLE Mask */

            #define PMU_CTRL_EVENTCNT_RESET_Pos 1U /*!< PMU CTRL: Event Counter Reset Position */
            #define PMU_CTRL_EVENTCNT_RESET_Msk                                                    \
                (1UL << PMU_CTRL_EVENTCNT_RESET_Pos) /*!< PMU CTRL: Event Counter Reset Mask */

            #define PMU_CTRL_CYCCNT_RESET_Pos 2U /*!< PMU CTRL: Cycle Counter Reset Position */
            #define PMU_CTRL_CYCCNT_RESET_Msk                                                      \
                (1UL << PMU_CTRL_CYCCNT_RESET_Pos) /*!< PMU CTRL: Cycle Counter Reset Mask */

            #define PMU_CTRL_CYCCNT_DISABLE_Pos                                                    \
                5U /*!< PMU CTRL: Disable Cycle Counter Position                                   \
                    */
            #define PMU_CTRL_CYCCNT_DISABLE_Msk                                                    \
                (1UL << PMU_CTRL_CYCCNT_DISABLE_Pos) /*!< PMU CTRL: Disable Cycle Counter Mask */

            #define PMU_CTRL_FRZ_ON_OV_Pos 9U /*!< PMU CTRL: Freeze-on-overflow Position */
            #define PMU_CTRL_FRZ_ON_OV_Msk                                                         \
                (1UL << PMU_CTRL_FRZ_ON_OVERFLOW_Pos) /*!< PMU CTRL: Freeze-on-overflow Mask */

            #define PMU_CTRL_TRACE_ON_OV_Pos 11U /*!< PMU CTRL: Trace-on-overflow Position */
            #define PMU_CTRL_TRACE_ON_OV_Msk                                                       \
                (1UL << PMU_CTRL_TRACE_ON_OVERFLOW_Pos) /*!< PMU CTRL: Trace-on-overflow Mask */
        ...
        /** \brief PMU Type Register Definitions */
            ...
            #define PMU_TYPE_NUM_CNTS_Msk                                                          \
                (0xFFUL /*<< PMU_TYPE_NUM_CNTS_Pos*/) /*!< PMU TYPE: Number of Counters Mask */

            #define PMU_TYPE_SIZE_CNTS_Pos 8U /*!< PMU TYPE: Size of Counters Position */
            #define PMU_TYPE_SIZE_CNTS_Msk                                                         \
                (0x3FUL << PMU_TYPE_SIZE_CNTS_Pos) /*!< PMU TYPE: Size of Counters Mask */

            #define PMU_TYPE_CYCCNT_PRESENT_Pos                                                    \
                14U /*!< PMU TYPE: Cycle Counter Present Position                                  \
                     */
            #define PMU_TYPE_CYCCNT_PRESENT_Msk                                                    \
                (1UL << PMU_TYPE_CYCCNT_PRESENT_Pos) /*!< PMU TYPE: Cycle Counter Present Mask */

            #define PMU_TYPE_FRZ_OV_SUPPORT_Pos                                                    \
                21U /*!< PMU TYPE: Freeze-on-overflow Support Position */
            #define PMU_TYPE_FRZ_OV_SUPPORT_Msk                                                    \
                (1UL                                                                               \
                 << PMU_TYPE_FRZ_OV_SUPPORT_Pos) /*!< PMU TYPE: Freeze-on-overflow Support Mask */

            #define PMU_TYPE_TRACE_ON_OV_SUPPORT_Pos                                               \
                23U /*!< PMU TYPE: Trace-on-overflow Support Position */
            #define PMU_TYPE_TRACE_ON_OV_SUPPORT_Msk                                               \
                (1UL                                                                               \
                 << PMU_TYPE_FRZ_OV_SUPPORT_Pos) /*!< PMU TYPE: Trace-on-overflow Support Mask */

        /** \brief PMU Authentication Status Register Definitions */

            #define PMU_AUTHSTATUS_NSID_Pos                                                        \
                0U /*!< PMU AUTHSTATUS: Non-secure Invasive Debug Position */
            #define PMU_AUTHSTATUS_NSID_Msk                                                        \
                (0x3UL /*<< PMU_AUTHSTATUS_NSID_Pos*/) /*!< PMU AUTHSTATUS: Non-secure Invasive    \
                                                          Debug Mask */

            #define PMU_AUTHSTATUS_NSNID_Pos                                                       \
                2U /*!< PMU AUTHSTATUS: Non-secure Non-invasive Debug Position */
            #define PMU_AUTHSTATUS_NSNID_Msk                                                       \
                (0x3UL << PMU_AUTHSTATUS_NSNID_Pos) /*!< PMU AUTHSTATUS: Non-secure Non-invasive   \
                                                       Debug Mask */

            #define PMU_AUTHSTATUS_SID_Pos                                                         \
                4U /*!< PMU AUTHSTATUS: Secure Invasive Debug Position                             \
                    */
            #define PMU_AUTHSTATUS_SID_Msk                                                         \
                (0x3UL << PMU_AUTHSTATUS_SID_Pos) /*!< PMU AUTHSTATUS: Secure Invasive Debug Mask  \
                                                   */

            #define PMU_AUTHSTATUS_SNID_Pos                                                        \
                6U /*!< PMU AUTHSTATUS: Secure Non-invasive Debug Position */
            #define PMU_AUTHSTATUS_SNID_Msk                                                        \
                (0x3UL << PMU_AUTHSTATUS_SNID_Pos) /*!< PMU AUTHSTATUS: Secure Non-invasive Debug  \
                                                      Mask */

            #define PMU_AUTHSTATUS_NSUID_Pos                                                       \
                16U /*!< PMU AUTHSTATUS: Non-secure Unprivileged Invasive Debug Position */
            #define PMU_AUTHSTATUS_NSUID_Msk                                                       \
                (0x3UL << PMU_AUTHSTATUS_NSUID_Pos) /*!< PMU AUTHSTATUS: Non-secure Unprivileged   \
                                                       Invasive Debug Mask */

            #define PMU_AUTHSTATUS_NSUNID_Pos                                                      \
                18U /*!< PMU AUTHSTATUS: Non-secure Unprivileged Non-invasive Debug Position */
            #define PMU_AUTHSTATUS_NSUNID_Msk                                                      \
                (0x3UL << PMU_AUTHSTATUS_NSUNID_Pos) /*!< PMU AUTHSTATUS: Non-secure Unprivileged  \
            ...
            #define PMU_AUTHSTATUS_SUNID_Pos                                                       \
                22U /*!< PMU AUTHSTATUS: Secure Unprivileged Non-invasive Debug Position */
...
typedef struct {
    ...
    union {
        ...
        struct {
            __IOM uint32_t
                MAIR0; /*!< Offset: 0x030 (R/W)  MPU Memory Attribute Indirection Register 0 */
            __IOM uint32_t
                MAIR1; /*!< Offset: 0x034 (R/W)  MPU Memory Attribute Indirection Register 1 */
        };
    };
} MPU_Type;
            ...
            #define MPU_RLAR_AttrIndx_Msk                                                          \
                (7UL << MPU_RLAR_AttrIndx_Pos) /*!< MPU RLAR: AttrIndx Mask */
...
typedef struct {
    ...
    __IM uint32_t MVFR2; /*!< Offset: 0x018 (R/ )  Media and VFP Feature Register 2 */
        ...
        #define FPU_FPCCR_S_Msk                                                                    \
            (1UL << FPU_FPCCR_S_Pos) /*!< FPCCR: Security status of the FP context bit Mask */
        ...
        #define FPU_FPDSCR_LTPSIZE_Msk                                                             \
            (7UL << FPU_FPDSCR_LTPSIZE_Pos) /*!< FPDSCR: LTPSIZE bit Mask */

        /* Media and VFP Feature Register 0 Definitions */
        #define FPU_MVFR0_FPRound_Pos 28U /*!< MVFR0: FPRound bits Position */
        #define FPU_MVFR0_FPRound_Msk                                                              \
            (0xFUL << FPU_MVFR0_FPRound_Pos) /*!< MVFR0: FPRound bits Mask */

        #define FPU_MVFR0_FPSqrt_Pos 20U /*!< MVFR0: FPSqrt bits Position */
        #define FPU_MVFR0_FPSqrt_Msk                                                               \
            (0xFUL << FPU_MVFR0_FPSqrt_Pos) /*!< MVFR0: FPSqrt bits Mask                           \
                                             */

        #define FPU_MVFR0_FPDivide_Pos 16U /*!< MVFR0: FPDivide bits Position */
        #define FPU_MVFR0_FPDivide_Msk                                                             \
            (0xFUL << FPU_MVFR0_FPDivide_Pos) /*!< MVFR0: Divide bits Mask */
        ...
        #define FPU_MVFR0_SIMDReg_Msk                                                              \
            (0xFUL /*<< FPU_MVFR0_SIMDReg_Pos*/) /*!< MVFR0: SIMDReg bits Mask */
        ...
        #define FPU_MVFR1_FPDNaN_Msk                                                               \
            (0xFUL << FPU_MVFR1_FPDNaN_Pos) /*!< MVFR1: FPDNaN bits Mask                           \
                                             */

        #define FPU_MVFR1_FPFtZ_Pos 0U /*!< MVFR1: FPFtZ bits Position */
        #define FPU_MVFR1_FPFtZ_Msk                                                                \
            (0xFUL /*<< FPU_MVFR1_FPFtZ_Pos*/) /*!< MVFR1: FPFtZ bits Mask */

        /* Media and VFP Feature Register 2 Definitions */
        #define FPU_MVFR2_FPMisc_Pos 4U /*!< MVFR2: FPMisc bits Position */
        #define FPU_MVFR2_FPMisc_Msk                                                               \
            (0xFUL << FPU_MVFR2_FPMisc_Pos) /*!< MVFR2: FPMisc bits Mask                           \
                                             */
...
typedef struct {
    ...
    __OM uint32_t
        DSCEMCR; /*!< Offset: 0x010 ( /W)  Debug Set Clear Exception and Monitor Control Register */
    ...
    __IOM uint32_t DSCSR; /*!< Offset: 0x018 (R/W)  Debug Security Control and Status Register */
        ...
        #define CoreDebug_DHCSR_DBGKEY_Pos                                                         \
            16U /*!< \deprecated CoreDebug DHCSR: DBGKEY Position                                  \
                 */
        #define CoreDebug_DHCSR_DBGKEY_Msk                                                         \
            (0xFFFFUL                                                                              \
             << CoreDebug_DHCSR_DBGKEY_Pos) /*!< \deprecated CoreDebug DHCSR: DBGKEY Mask */

        #define CoreDebug_DHCSR_S_RESTART_ST_Pos                                                   \
            26U /*!< \deprecated CoreDebug DHCSR: S_RESTART_ST Position */
        #define CoreDebug_DHCSR_S_RESTART_ST_Msk                                                   \
            (1UL << CoreDebug_DHCSR_S_RESTART_ST_Pos) /*!< \deprecated CoreDebug DHCSR:            \
                                                         S_RESTART_ST Mask */
        ...
        #define CoreDebug_DHCSR_S_RESET_ST_Msk                                                     \
            (1UL << CoreDebug_DHCSR_S_RESET_ST_Pos) /*!< \deprecated CoreDebug DHCSR: S_RESET_ST   \
                                                       Mask */

        #define CoreDebug_DHCSR_S_RETIRE_ST_Pos                                                    \
            24U /*!< \deprecated CoreDebug DHCSR: S_RETIRE_ST Position */
        #define CoreDebug_DHCSR_S_RETIRE_ST_Msk                                                    \
            (1UL << CoreDebug_DHCSR_S_RETIRE_ST_Pos) /*!< \deprecated CoreDebug DHCSR: S_RETIRE_ST \
                                                        Mask */

        #define CoreDebug_DHCSR_S_FPD_Pos 23U /*!< \deprecated CoreDebug DHCSR: S_FPD Position */
        #define CoreDebug_DHCSR_S_FPD_Msk                                                          \
            (1UL << CoreDebug_DHCSR_S_FPD_Pos) /*!< \deprecated CoreDebug DHCSR: S_FPD Mask */

        #define CoreDebug_DHCSR_S_SUIDE_Pos                                                        \
            22U /*!< \deprecated CoreDebug DHCSR: S_SUIDE Position */
        #define CoreDebug_DHCSR_S_SUIDE_Msk                                                        \
            (1UL << CoreDebug_DHCSR_S_SUIDE_Pos) /*!< \deprecated CoreDebug DHCSR: S_SUIDE Mask */

        #define CoreDebug_DHCSR_S_NSUIDE_Pos                                                       \
            21U /*!< \deprecated CoreDebug DHCSR: S_NSUIDE Position */
        #define CoreDebug_DHCSR_S_NSUIDE_Msk                                                       \
            (1UL << CoreDebug_DHCSR_S_NSUIDE_Pos) /*!< \deprecated CoreDebug DHCSR: S_NSUIDE Mask  \
                                                   */

        #define CoreDebug_DHCSR_S_SDE_Pos 20U /*!< \deprecated CoreDebug DHCSR: S_SDE Position */
        #define CoreDebug_DHCSR_S_SDE_Msk                                                          \
            (1UL << CoreDebug_DHCSR_S_SDE_Pos) /*!< \deprecated CoreDebug DHCSR: S_SDE Mask */

        #define CoreDebug_DHCSR_S_LOCKUP_Pos                                                       \
            19U /*!< \deprecated CoreDebug DHCSR: S_LOCKUP Position */
        #define CoreDebug_DHCSR_S_LOCKUP_Msk                                                       \
            (1UL << CoreDebug_DHCSR_S_LOCKUP_Pos) /*!< \deprecated CoreDebug DHCSR: S_LOCKUP Mask  \
                                                   */

        #define CoreDebug_DHCSR_S_SLEEP_Pos                                                        \
            18U /*!< \deprecated CoreDebug DHCSR: S_SLEEP Position */
        #define CoreDebug_DHCSR_S_SLEEP_Msk                                                        \
            (1UL << CoreDebug_DHCSR_S_SLEEP_Pos) /*!< \deprecated CoreDebug DHCSR: S_SLEEP Mask */

        #define CoreDebug_DHCSR_S_HALT_Pos                                                         \
            17U /*!< \deprecated CoreDebug DHCSR: S_HALT Position                                  \
                 */
        #define CoreDebug_DHCSR_S_HALT_Msk                                                         \
            (1UL << CoreDebug_DHCSR_S_HALT_Pos) /*!< \deprecated CoreDebug DHCSR: S_HALT Mask */

        #define CoreDebug_DHCSR_S_REGRDY_Pos                                                       \
            16U /*!< \deprecated CoreDebug DHCSR: S_REGRDY Position */
        #define CoreDebug_DHCSR_S_REGRDY_Msk                                                       \
            (1UL << CoreDebug_DHCSR_S_REGRDY_Pos) /*!< \deprecated CoreDebug DHCSR: S_REGRDY Mask  \
                                                   */

        #define CoreDebug_DHCSR_C_PMOV_Pos 6U /*!< \deprecated CoreDebug DHCSR: C_PMOV Position */
        #define CoreDebug_DHCSR_C_PMOV_Msk                                                         \
            (1UL << CoreDebug_DHCSR_C_PMOV_Pos) /*!< \deprecated CoreDebug DHCSR: C_PMOV Mask */

        #define CoreDebug_DHCSR_C_SNAPSTALL_Pos                                                    \
            5U /*!< \deprecated CoreDebug DHCSR: C_SNAPSTALL Position */
        #define CoreDebug_DHCSR_C_SNAPSTALL_Msk                                                    \
            (1UL << CoreDebug_DHCSR_C_SNAPSTALL_Pos) /*!< \deprecated CoreDebug DHCSR: C_SNAPSTALL \
                                                        Mask */

        #define CoreDebug_DHCSR_C_MASKINTS_Pos                                                     \
            3U /*!< \deprecated CoreDebug DHCSR: C_MASKINTS Position */
        ...
        #define CoreDebug_DHCSR_C_STEP_Msk                                                         \
            (1UL << CoreDebug_DHCSR_C_STEP_Pos) /*!< \deprecated CoreDebug DHCSR: C_STEP Mask */

        #define CoreDebug_DHCSR_C_HALT_Pos 1U /*!< \deprecated CoreDebug DHCSR: C_HALT Position */
        #define CoreDebug_DHCSR_C_HALT_Msk                                                         \
            (1UL << CoreDebug_DHCSR_C_HALT_Pos) /*!< \deprecated CoreDebug DHCSR: C_HALT Mask */

        #define CoreDebug_DHCSR_C_DEBUGEN_Pos                                                      \
            0U /*!< \deprecated CoreDebug DHCSR: C_DEBUGEN Position */
        #define CoreDebug_DHCSR_C_DEBUGEN_Msk                                                      \
            (1UL /*<< CoreDebug_DHCSR_C_DEBUGEN_Pos*/) /*!< \deprecated CoreDebug DHCSR: C_DEBUGEN \
                                                          Mask */

        /* Debug Core Register Selector Register Definitions */
        #define CoreDebug_DCRSR_REGWnR_Pos                                                         \
            16U /*!< \deprecated CoreDebug DCRSR: REGWnR Position                                  \
                 */
        #define CoreDebug_DCRSR_REGWnR_Msk                                                         \
            (1UL << CoreDebug_DCRSR_REGWnR_Pos) /*!< \deprecated CoreDebug DCRSR: REGWnR Mask */

        #define CoreDebug_DCRSR_REGSEL_Pos 0U /*!< \deprecated CoreDebug DCRSR: REGSEL Position */
        #define CoreDebug_DCRSR_REGSEL_Msk                                                         \
            (0x1FUL /*<< CoreDebug_DCRSR_REGSEL_Pos*/) /*!< \deprecated CoreDebug DCRSR: REGSEL    \
                                                          Mask */

        /* Debug Exception and Monitor Control Register Definitions */
        #define CoreDebug_DEMCR_TRCENA_Pos                                                         \
            24U /*!< \deprecated CoreDebug DEMCR: TRCENA Position                                  \
                 */
        #define CoreDebug_DEMCR_TRCENA_Msk                                                         \
            (1UL << CoreDebug_DEMCR_TRCENA_Pos) /*!< \deprecated CoreDebug DEMCR: TRCENA Mask */

        #define CoreDebug_DEMCR_MON_REQ_Pos                                                        \
            19U /*!< \deprecated CoreDebug DEMCR: MON_REQ Position */
        #define CoreDebug_DEMCR_MON_REQ_Msk                                                        \
            (1UL << CoreDebug_DEMCR_MON_REQ_Pos) /*!< \deprecated CoreDebug DEMCR: MON_REQ Mask */

        #define CoreDebug_DEMCR_MON_STEP_Pos                                                       \
            18U /*!< \deprecated CoreDebug DEMCR: MON_STEP Position */
        #define CoreDebug_DEMCR_MON_STEP_Msk                                                       \
            (1UL << CoreDebug_DEMCR_MON_STEP_Pos) /*!< \deprecated CoreDebug DEMCR: MON_STEP Mask  \
                                                   */

        #define CoreDebug_DEMCR_MON_PEND_Pos                                                       \
            17U /*!< \deprecated CoreDebug DEMCR: MON_PEND Position */
        #define CoreDebug_DEMCR_MON_PEND_Msk                                                       \
            (1UL << CoreDebug_DEMCR_MON_PEND_Pos) /*!< \deprecated CoreDebug DEMCR: MON_PEND Mask  \
                                                   */

        #define CoreDebug_DEMCR_MON_EN_Pos                                                         \
            16U /*!< \deprecated CoreDebug DEMCR: MON_EN Position                                  \
                 */
        #define CoreDebug_DEMCR_MON_EN_Msk                                                         \
            (1UL << CoreDebug_DEMCR_MON_EN_Pos) /*!< \deprecated CoreDebug DEMCR: MON_EN Mask */
        ...
        #define CoreDebug_DEMCR_VC_HARDERR_Msk                                                     \
            (1UL << CoreDebug_DEMCR_VC_HARDERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_HARDERR   \
                                                       Mask */

        #define CoreDebug_DEMCR_VC_INTERR_Pos                                                      \
            9U /*!< \deprecated CoreDebug DEMCR: VC_INTERR Position */
        #define CoreDebug_DEMCR_VC_INTERR_Msk                                                      \
            (1UL                                                                                   \
             << CoreDebug_DEMCR_VC_INTERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_INTERR Mask */

        #define CoreDebug_DEMCR_VC_BUSERR_Pos                                                      \
            8U /*!< \deprecated CoreDebug DEMCR: VC_BUSERR Position */
        #define CoreDebug_DEMCR_VC_BUSERR_Msk                                                      \
            (1UL                                                                                   \
             << CoreDebug_DEMCR_VC_BUSERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_BUSERR Mask */

        #define CoreDebug_DEMCR_VC_STATERR_Pos                                                     \
            7U /*!< \deprecated CoreDebug DEMCR: VC_STATERR Position */
        #define CoreDebug_DEMCR_VC_STATERR_Msk                                                     \
            (1UL << CoreDebug_DEMCR_VC_STATERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_STATERR   \
                                                       Mask */

        #define CoreDebug_DEMCR_VC_CHKERR_Pos                                                      \
            6U /*!< \deprecated CoreDebug DEMCR: VC_CHKERR Position */
        #define CoreDebug_DEMCR_VC_CHKERR_Msk                                                      \
            (1UL                                                                                   \
             << CoreDebug_DEMCR_VC_CHKERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_CHKERR Mask */

        #define CoreDebug_DEMCR_VC_NOCPERR_Pos                                                     \
            5U /*!< \deprecated CoreDebug DEMCR: VC_NOCPERR Position */
        #define CoreDebug_DEMCR_VC_NOCPERR_Msk                                                     \
            (1UL << CoreDebug_DEMCR_VC_NOCPERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_NOCPERR   \
                                                       Mask */

        #define CoreDebug_DEMCR_VC_MMERR_Pos                                                       \
            4U /*!< \deprecated CoreDebug DEMCR: VC_MMERR Position */
        #define CoreDebug_DEMCR_VC_MMERR_Msk                                                       \
            (1UL << CoreDebug_DEMCR_VC_MMERR_Pos) /*!< \deprecated CoreDebug DEMCR: VC_MMERR Mask  \
                                                   */

        #define CoreDebug_DEMCR_VC_CORERESET_Pos                                                   \
            0U /*!< \deprecated CoreDebug DEMCR: VC_CORERESET Position */
        #define CoreDebug_DEMCR_VC_CORERESET_Msk                                                   \
            (1UL /*<< CoreDebug_DEMCR_VC_CORERESET_Pos*/) /*!< \deprecated CoreDebug DEMCR:        \
                                                             VC_CORERESET Mask */

        /* Debug Set Clear Exception and Monitor Control Register Definitions */
        #define CoreDebug_DSCEMCR_CLR_MON_REQ_Pos                                                  \
            19U /*!< \deprecated CoreDebug DSCEMCR: CLR_MON_REQ, Position */
        #define CoreDebug_DSCEMCR_CLR_MON_REQ_Msk                                                  \
            (1UL << CoreDebug_DSCEMCR_CLR_MON_REQ_Pos) /*!< \deprecated CoreDebug DSCEMCR:         \
                                                          CLR_MON_REQ, Mask */

        #define CoreDebug_DSCEMCR_CLR_MON_PEND_Pos                                                 \
            17U /*!< \deprecated CoreDebug DSCEMCR: CLR_MON_PEND, Position */
        #define CoreDebug_DSCEMCR_CLR_MON_PEND_Msk                                                 \
            (1UL << CoreDebug_DSCEMCR_CLR_MON_PEND_Pos) /*!< \deprecated CoreDebug DSCEMCR:        \
                                                           CLR_MON_PEND, Mask */

        #define CoreDebug_DSCEMCR_SET_MON_REQ_Pos                                                  \
            3U /*!< \deprecated CoreDebug DSCEMCR: SET_MON_REQ, Position */
        #define CoreDebug_DSCEMCR_SET_MON_REQ_Msk                                                  \
            (1UL << CoreDebug_DSCEMCR_SET_MON_REQ_Pos) /*!< \deprecated CoreDebug DSCEMCR:         \
                                                          SET_MON_REQ, Mask */

        #define CoreDebug_DSCEMCR_SET_MON_PEND_Pos                                                 \
            1U /*!< \deprecated CoreDebug DSCEMCR: SET_MON_PEND, Position */
        #define CoreDebug_DSCEMCR_SET_MON_PEND_Msk                                                 \
            (1UL << CoreDebug_DSCEMCR_SET_MON_PEND_Pos) /*!< \deprecated CoreDebug DSCEMCR:        \
                                                           SET_MON_PEND, Mask */

        /* Debug Authentication Control Register Definitions */
        #define CoreDebug_DAUTHCTRL_UIDEN_Pos                                                      \
            10U /*!< \deprecated CoreDebug DAUTHCTRL: UIDEN, Position */
        #define CoreDebug_DAUTHCTRL_UIDEN_Msk                                                      \
            (1UL << CoreDebug_DAUTHCTRL_UIDEN_Pos) /*!< \deprecated CoreDebug DAUTHCTRL: UIDEN,    \
                                                      Mask */

        #define CoreDebug_DAUTHCTRL_UIDAPEN_Pos                                                    \
            9U /*!< \deprecated CoreDebug DAUTHCTRL: UIDAPEN, Position */
        #define CoreDebug_DAUTHCTRL_UIDAPEN_Msk                                                    \
            (1UL << CoreDebug_DAUTHCTRL_UIDAPEN_Pos) /*!< \deprecated CoreDebug DAUTHCTRL:         \
                                                        UIDAPEN, Mask */

        #define CoreDebug_DAUTHCTRL_FSDMA_Pos                                                      \
            8U /*!< \deprecated CoreDebug DAUTHCTRL: FSDMA, Position */
        #define CoreDebug_DAUTHCTRL_FSDMA_Msk                                                      \
            (1UL << CoreDebug_DAUTHCTRL_FSDMA_Pos) /*!< \deprecated CoreDebug DAUTHCTRL: FSDMA,    \
                                                      Mask */

        #define CoreDebug_DAUTHCTRL_INTSPNIDEN_Pos                                                 \
            3U /*!< \deprecated CoreDebug DAUTHCTRL: INTSPNIDEN, Position */
        #define CoreDebug_DAUTHCTRL_INTSPNIDEN_Msk                                                 \
            (1UL << CoreDebug_DAUTHCTRL_INTSPNIDEN_Pos) /*!< \deprecated CoreDebug DAUTHCTRL:      \
                                                           INTSPNIDEN, Mask */

        #define CoreDebug_DAUTHCTRL_SPNIDENSEL_Pos                                                 \
            2U /*!< \deprecated CoreDebug DAUTHCTRL: SPNIDENSEL Position */
        #define CoreDebug_DAUTHCTRL_SPNIDENSEL_Msk                                                 \
            (1UL << CoreDebug_DAUTHCTRL_SPNIDENSEL_Pos) /*!< \deprecated CoreDebug DAUTHCTRL:      \
                                                           SPNIDENSEL Mask */

        #define CoreDebug_DAUTHCTRL_INTSPIDEN_Pos                                                  \
            1U /*!< \deprecated CoreDebug DAUTHCTRL: INTSPIDEN Position */
        #define CoreDebug_DAUTHCTRL_INTSPIDEN_Msk                                                  \
            (1UL << CoreDebug_DAUTHCTRL_INTSPIDEN_Pos) /*!< \deprecated CoreDebug DAUTHCTRL:       \
                                                          INTSPIDEN Mask */

        #define CoreDebug_DAUTHCTRL_SPIDENSEL_Pos                                                  \
            0U /*!< \deprecated CoreDebug DAUTHCTRL: SPIDENSEL Position */
        #define CoreDebug_DAUTHCTRL_SPIDENSEL_Msk                                                  \
            (1UL /*<< CoreDebug_DAUTHCTRL_SPIDENSEL_Pos*/) /*!< \deprecated CoreDebug DAUTHCTRL:   \
                                                              SPIDENSEL Mask */

        /* Debug Security Control and Status Register Definitions */
        #define CoreDebug_DSCSR_CDS_Pos 16U /*!< \deprecated CoreDebug DSCSR: CDS Position */
        #define CoreDebug_DSCSR_CDS_Msk                                                            \
            (1UL << CoreDebug_DSCSR_CDS_Pos) /*!< \deprecated CoreDebug DSCSR: CDS Mask */

        #define CoreDebug_DSCSR_SBRSEL_Pos 1U /*!< \deprecated CoreDebug DSCSR: SBRSEL Position */
        #define CoreDebug_DSCSR_SBRSEL_Msk                                                         \
            (1UL << CoreDebug_DSCSR_SBRSEL_Pos) /*!< \deprecated CoreDebug DSCSR: SBRSEL Mask */

        #define CoreDebug_DSCSR_SBRSELEN_Pos                                                       \
            0U /*!< \deprecated CoreDebug DSCSR: SBRSELEN Position */
        #define CoreDebug_DSCSR_SBRSELEN_Msk                                                       \
            (1UL /*<< CoreDebug_DSCSR_SBRSELEN_Pos*/) /*!< \deprecated CoreDebug DSCSR: SBRSELEN   \
                                                         Mask */
...
typedef struct {
    ...
    __IOM uint32_t DSCSR; /*!< Offset: 0x018 (R/W)  Debug Security Control and Status Register */
        ...
        #define DCB_DHCSR_DBGKEY_Msk                                                               \
            (0xFFFFUL << DCB_DHCSR_DBGKEY_Pos) /*!< DCB DHCSR: Debug key Mask */

        #define DCB_DHCSR_S_RESTART_ST_Pos 26U /*!< DCB DHCSR: Restart sticky status Position */
        #define DCB_DHCSR_S_RESTART_ST_Msk                                                         \
            (0x1UL << DCB_DHCSR_S_RESTART_ST_Pos) /*!< DCB DHCSR: Restart sticky status Mask */

        #define DCB_DHCSR_S_RESET_ST_Pos 25U /*!< DCB DHCSR: Reset sticky status Position */
        #define DCB_DHCSR_S_RESET_ST_Msk                                                           \
            (0x1UL << DCB_DHCSR_S_RESET_ST_Pos) /*!< DCB DHCSR: Reset sticky status Mask */

        #define DCB_DHCSR_S_RETIRE_ST_Pos 24U /*!< DCB DHCSR: Retire sticky status Position */
        #define DCB_DHCSR_S_RETIRE_ST_Msk                                                          \
            (0x1UL << DCB_DHCSR_S_RETIRE_ST_Pos) /*!< DCB DHCSR: Retire sticky status Mask */

        #define DCB_DHCSR_S_FPD_Pos                                                                \
            23U /*!< DCB DHCSR: Floating-point registers Debuggable Position */
        #define DCB_DHCSR_S_FPD_Msk                                                                \
            (0x1UL                                                                                 \
             << DCB_DHCSR_S_FPD_Pos) /*!< DCB DHCSR: Floating-point registers Debuggable Mask */

        #define DCB_DHCSR_S_SUIDE_Pos                                                              \
            22U /*!< DCB DHCSR: Secure unprivileged halting debug enabled Position */
        #define DCB_DHCSR_S_SUIDE_Msk                                                              \
            (0x1UL << DCB_DHCSR_S_SUIDE_Pos) /*!< DCB DHCSR: Secure unprivileged halting debug     \
                                                enabled Mask */

        #define DCB_DHCSR_S_NSUIDE_Pos                                                             \
            21U /*!< DCB DHCSR: Non-secure unprivileged halting debug enabled Position */
        #define DCB_DHCSR_S_NSUIDE_Msk                                                             \
            (0x1UL << DCB_DHCSR_S_NSUIDE_Pos) /*!< DCB DHCSR: Non-secure unprivileged halting      \
                                                 debug enabled Mask */

        #define DCB_DHCSR_S_SDE_Pos 20U /*!< DCB DHCSR: Secure debug enabled Position */
        #define DCB_DHCSR_S_SDE_Msk                                                                \
            (0x1UL << DCB_DHCSR_S_SDE_Pos) /*!< DCB DHCSR: Secure debug enabled Mask */
        ...
        #define DCB_DCRSR_REGWnR_Msk                                                               \
            (0x1UL << DCB_DCRSR_REGWnR_Pos) /*!< DCB DCRSR: Register write/not-read Mask */

        #define DCB_DCRSR_REGSEL_Pos 0U /*!< DCB DCRSR: Register selector Position */
        #define DCB_DCRSR_REGSEL_Msk                                                               \
            (0x7FUL /*<< DCB_DCRSR_REGSEL_Pos*/) /*!< DCB DCRSR: Register selector Mask */
        ...
        #define DCB_DCRDR_DBGTMP_Msk                                                               \
            (0xFFFFFFFFUL /*<< DCB_DCRDR_DBGTMP_Pos*/) /*!< DCB DCRDR: Data temporary buffer Mask  \
                                                        */
        ...
        #define DCB_DEMCR_MON_STEP_Msk                                                             \
            (0x1UL << DCB_DEMCR_MON_STEP_Pos) /*!< DCB DEMCR: Monitor step Mask */

        #define DCB_DEMCR_MON_PEND_Pos 17U /*!< DCB DEMCR: Monitor pend Position */
        #define DCB_DEMCR_MON_PEND_Msk                                                             \
        ...
        #define DCB_DEMCR_VC_SFERR_Msk                                                             \
            (0x1UL << DCB_DEMCR_VC_SFERR_Pos) /*!< DCB DEMCR: Vector Catch SecureFault Mask */

        #define DCB_DEMCR_VC_HARDERR_Pos                                                           \
            10U /*!< DCB DEMCR: Vector Catch HardFault errors Position */
        #define DCB_DEMCR_VC_HARDERR_Msk                                                           \
            (0x1UL                                                                                 \
             << DCB_DEMCR_VC_HARDERR_Pos) /*!< DCB DEMCR: Vector Catch HardFault errors Mask */

        #define DCB_DEMCR_VC_INTERR_Pos                                                            \
            9U /*!< DCB DEMCR: Vector Catch interrupt errors Position                              \
                */
        #define DCB_DEMCR_VC_INTERR_Msk                                                            \
            (0x1UL << DCB_DEMCR_VC_INTERR_Pos) /*!< DCB DEMCR: Vector Catch interrupt errors Mask  \
                                                */

        #define DCB_DEMCR_VC_BUSERR_Pos                                                            \
            8U /*!< DCB DEMCR: Vector Catch BusFault errors Position                               \
                */
        #define DCB_DEMCR_VC_BUSERR_Msk                                                            \
            (0x1UL << DCB_DEMCR_VC_BUSERR_Pos) /*!< DCB DEMCR: Vector Catch BusFault errors Mask   \
                                                */

        #define DCB_DEMCR_VC_STATERR_Pos 7U /*!< DCB DEMCR: Vector Catch state errors Position */
        #define DCB_DEMCR_VC_STATERR_Msk                                                           \
            (0x1UL << DCB_DEMCR_VC_STATERR_Pos) /*!< DCB DEMCR: Vector Catch state errors Mask */

        #define DCB_DEMCR_VC_CHKERR_Pos 6U /*!< DCB DEMCR: Vector Catch check errors Position */
        #define DCB_DEMCR_VC_CHKERR_Msk                                                            \
            (0x1UL << DCB_DEMCR_VC_CHKERR_Pos) /*!< DCB DEMCR: Vector Catch check errors Mask */

        #define DCB_DEMCR_VC_NOCPERR_Pos 5U /*!< DCB DEMCR: Vector Catch NOCP errors Position */
        #define DCB_DEMCR_VC_NOCPERR_Msk                                                           \
            (0x1UL << DCB_DEMCR_VC_NOCPERR_Pos) /*!< DCB DEMCR: Vector Catch NOCP errors Mask */

        #define DCB_DEMCR_VC_MMERR_Pos                                                             \
            4U /*!< DCB DEMCR: Vector Catch MemManage errors Position                              \
                */
        #define DCB_DEMCR_VC_MMERR_Msk                                                             \
            (0x1UL << DCB_DEMCR_VC_MMERR_Pos) /*!< DCB DEMCR: Vector Catch MemManage errors Mask   \
                                               */

        #define DCB_DEMCR_VC_CORERESET_Pos 0U /*!< DCB DEMCR: Vector Catch Core reset Position */
        #define DCB_DEMCR_VC_CORERESET_Msk                                                         \
            (0x1UL /*<< DCB_DEMCR_VC_CORERESET_Pos*/) /*!< DCB DEMCR: Vector Catch Core reset Mask \
                                                       */

        /* DSCEMCR, Debug Set Clear Exception and Monitor Control Register Definitions */
        #define DCB_DSCEMCR_CLR_MON_REQ_Pos                                                        \
            19U /*!< DCB DSCEMCR: Clear monitor request Position                                   \
                 */
        #define DCB_DSCEMCR_CLR_MON_REQ_Msk                                                        \
            (0x1UL << DCB_DSCEMCR_CLR_MON_REQ_Pos) /*!< DCB DSCEMCR: Clear monitor request Mask */

        #define DCB_DSCEMCR_CLR_MON_PEND_Pos 17U /*!< DCB DSCEMCR: Clear monitor pend Position */
        #define DCB_DSCEMCR_CLR_MON_PEND_Msk                                                       \
            (0x1UL << DCB_DSCEMCR_CLR_MON_PEND_Pos) /*!< DCB DSCEMCR: Clear monitor pend Mask */

        #define DCB_DSCEMCR_SET_MON_REQ_Pos 3U /*!< DCB DSCEMCR: Set monitor request Position */
        #define DCB_DSCEMCR_SET_MON_REQ_Msk                                                        \
            (0x1UL << DCB_DSCEMCR_SET_MON_REQ_Pos) /*!< DCB DSCEMCR: Set monitor request Mask */

        #define DCB_DSCEMCR_SET_MON_PEND_Pos 1U /*!< DCB DSCEMCR: Set monitor pend Position */
        #define DCB_DSCEMCR_SET_MON_PEND_Msk                                                       \
            (0x1UL << DCB_DSCEMCR_SET_MON_PEND_Pos) /*!< DCB DSCEMCR: Set monitor pend Mask */

        /* DAUTHCTRL, Debug Authentication Control Register Definitions */
        #define DCB_DAUTHCTRL_UIDEN_Pos                                                            \
            10U /*!< DCB DAUTHCTRL: Unprivileged Invasive Debug Enable Position */
        #define DCB_DAUTHCTRL_UIDEN_Msk                                                            \
            (0x1UL << DCB_DAUTHCTRL_UIDEN_Pos) /*!< DCB DAUTHCTRL: Unprivileged Invasive Debug     \
                                                  Enable Mask */

        #define DCB_DAUTHCTRL_UIDAPEN_Pos                                                          \
            9U /*!< DCB DAUTHCTRL: Unprivileged Invasive DAP Access Enable Position */
        #define DCB_DAUTHCTRL_UIDAPEN_Msk                                                          \
            (0x1UL << DCB_DAUTHCTRL_UIDAPEN_Pos) /*!< DCB DAUTHCTRL: Unprivileged Invasive DAP     \
                                                    Access Enable Mask */

        #define DCB_DAUTHCTRL_FSDMA_Pos                                                            \
            8U /*!< DCB DAUTHCTRL: Force Secure DebugMonitor Allowed Position */
        #define DCB_DAUTHCTRL_FSDMA_Msk                                                            \
            (0x1UL << DCB_DAUTHCTRL_FSDMA_Pos) /*!< DCB DAUTHCTRL: Force Secure DebugMonitor       \
                                                  Allowed Mask */

        #define DCB_DAUTHCTRL_INTSPNIDEN_Pos                                                       \
            3U /*!< DCB DAUTHCTRL: Internal Secure non-invasive debug enable Position */
        ...
        #define DCB_DAUTHCTRL_SPNIDENSEL_Pos                                                       \
            2U /*!< DCB DAUTHCTRL: Secure non-invasive debug enable select Position */
        #define DCB_DAUTHCTRL_SPNIDENSEL_Msk                                                       \
            (0x1UL << DCB_DAUTHCTRL_SPNIDENSEL_Pos) /*!< DCB DAUTHCTRL: Secure non-invasive debug  \
                                                       enable select Mask */
        ...
        #define DCB_DAUTHCTRL_INTSPIDEN_Msk                                                        \
            (0x1UL << DCB_DAUTHCTRL_INTSPIDEN_Pos) /*!< DCB DAUTHCTRL: Internal Secure invasive    \
                                                      debug enable Mask */

        #define DCB_DAUTHCTRL_SPIDENSEL_Pos                                                        \
            0U /*!< DCB DAUTHCTRL: Secure invasive debug enable select Position */
        #define DCB_DAUTHCTRL_SPIDENSEL_Msk                                                        \
            (0x1UL /*<< DCB_DAUTHCTRL_SPIDENSEL_Pos*/) /*!< DCB DAUTHCTRL: Secure invasive debug   \
                                                          enable select Mask */
        ...
        #define DCB_DSCSR_SBRSEL_Msk                                                               \
            (0x1UL << DCB_DSCSR_SBRSEL_Pos) /*!< DCB DSCSR: Secure banked register select Mask */

        #define DCB_DSCSR_SBRSELEN_Pos                                                             \
            0U /*!< DCB DSCSR: Secure banked register select enable Position */
        #define DCB_DSCSR_SBRSELEN_Msk                                                             \
            (0x1UL /*<< DCB_DSCSR_SBRSELEN_Pos*/) /*!< DCB DSCSR: Secure banked register select    \
                                                     enable Mask */
...
typedef struct {
    ...
    __IM uint32_t DDEVTYPE; /*!< Offset: 0x01C (R/ )  SCS Device Type Register */
        ...
        #define DIB_DAUTHSTATUS_SUNID_Pos                                                          \
            22U /*!< DIB DAUTHSTATUS: Secure Unprivileged Non-invasive Debug Allowed Position */
        #define DIB_DAUTHSTATUS_SUNID_Msk                                                          \
            (0x3UL << DIB_DAUTHSTATUS_SUNID_Pos) /*!< DIB DAUTHSTATUS: Secure Unprivileged         \
                                                    Non-invasive Debug Allowed Mask */

        #define DIB_DAUTHSTATUS_SUID_Pos                                                           \
            20U /*!< DIB DAUTHSTATUS: Secure Unprivileged Invasive Debug Allowed Position */
        #define DIB_DAUTHSTATUS_SUID_Msk                                                           \
            (0x3UL << DIB_DAUTHSTATUS_SUID_Pos) /*!< DIB DAUTHSTATUS: Secure Unprivileged Invasive \
                                                   Debug Allowed Mask */

        #define DIB_DAUTHSTATUS_NSUNID_Pos                                                         \
            18U /*!< DIB DAUTHSTATUS: Non-secure Unprivileged Non-invasive Debug Allo Position */
        #define DIB_DAUTHSTATUS_NSUNID_Msk                                                         \
            (0x3UL << DIB_DAUTHSTATUS_NSUNID_Pos) /*!< DIB DAUTHSTATUS: Non-secure Unprivileged    \
                                                     Non-invasive Debug Allo Mask */

        #define DIB_DAUTHSTATUS_NSUID_Pos                                                          \
            16U /*!< DIB DAUTHSTATUS: Non-secure Unprivileged Invasive Debug Allowed Position */
        #define DIB_DAUTHSTATUS_NSUID_Msk                                                          \
            (0x3UL << DIB_DAUTHSTATUS_NSUID_Pos) /*!< DIB DAUTHSTATUS: Non-secure Unprivileged     \
                                                    Invasive Debug Allowed Mask */

        #define DIB_DAUTHSTATUS_SNID_Pos                                                           \
            6U /*!< DIB DAUTHSTATUS: Secure Non-invasive Debug Position */
        #define DIB_DAUTHSTATUS_SNID_Msk                                                           \
            (0x3UL                                                                                 \
             << DIB_DAUTHSTATUS_SNID_Pos) /*!< DIB DAUTHSTATUS: Secure Non-invasive Debug Mask */
        ...
        #define DIB_DAUTHSTATUS_NSNID_Msk                                                          \
            (0x3UL << DIB_DAUTHSTATUS_NSNID_Pos) /*!< DIB DAUTHSTATUS: Non-secure Non-invasive     \
                                                    Debug Mask */

        #define DIB_DAUTHSTATUS_NSID_Pos                                                           \
            0U /*!< DIB DAUTHSTATUS: Non-secure Invasive Debug Position */
        #define DIB_DAUTHSTATUS_NSID_Msk                                                           \
            (0x3UL /*<< DIB_DAUTHSTATUS_NSID_Pos*/) /*!< DIB DAUTHSTATUS: Non-secure Invasive      \
                                                       Debug Mask */
        ...
        #define DIB_DDEVARCH_ARCHITECT_Msk                                                         \
            (0x7FFUL << DIB_DDEVARCH_ARCHITECT_Pos) /*!< DIB DDEVARCH: Architect Mask */

        #define DIB_DDEVARCH_PRESENT_Pos 20U /*!< DIB DDEVARCH: DEVARCH Present Position */
        #define DIB_DDEVARCH_PRESENT_Msk                                                           \
            (0x1FUL << DIB_DDEVARCH_PRESENT_Pos) /*!< DIB DDEVARCH: DEVARCH Present Mask */
    ...
    /* Memory mapping of Core Hardware */
        ...
        #define EWIC_ISA_BASE                                                                      \
            (0xE001E400UL) /*!< External Wakeup Interrupt Controller interrupt status access Base  \
                              Address */
        ...
        #define MEMSYSCTL                                                                          \
            ((MemSysCtl_Type *)MEMSYSCTL_BASE) /*!< Memory System Control configuration struct */
        #define ERRBNK ((ErrBnk_Type *)ERRBNK_BASE) /*!< Error Banking configuration struct */
        #define PWRMODCTL                                                                          \
            ((PwrModCtl_Type *)PWRMODCTL_BASE) /*!< Power Mode Control configuration struct */
        #define EWIC_ISA                                                                           \
            ((EWIC_ISA_Type *)EWIC_ISA_BASE)  /*!< EWIC interrupt status access struct */
        #define EWIC ((EWIC_Type *)EWIC_BASE) /*!< EWIC configuration struct */
        #define PRCCFGINF                                                                          \
            ((PrcCfgInf_Type *)                                                                    \
                 PRCCFGINF_BASE) /*!< Processor Configuration Information configuration struct */
        #define STL ((STL_Type *)STL_BASE) /*!< Software Test Library configuration struct */
        #define CoreDebug                                                                          \
            ((CoreDebug_Type *)CoreDebug_BASE) /*!< \deprecated Core Debug configuration struct */
        ...
        #define FPU ((FPU_Type *)FPU_BASE)     /*!< Floating Point Unit */
            ...
            #define CoreDebug_BASE_NS                                                              \
                (0xE002EDF0UL) /*!< \deprecated Core Debug Base Address           (non-secure      \
                                  address space) */
            #define DCB_BASE_NS                                                                    \
                (0xE002EDF0UL) /*!< DCB Base Address                  (non-secure address space)   \
                                */
            #define DIB_BASE_NS                                                                    \
                (0xE002EFB0UL) /*!< DIB Base Address                  (non-secure address space)   \
                                */
            ...
            #define ICB_NS                                                                         \
                ((ICB_Type *)SCS_BASE_NS) /*!< System control Register not in SCB(non-secure       \
                                             address space) */
            #define SCB_NS                                                                         \
                ((SCB_Type *)SCB_BASE_NS) /*!< SCB configuration struct          (non-secure       \
                                             address space) */
            #define SysTick_NS                                                                     \
                ((SysTick_Type *)SysTick_BASE_NS) /*!< SysTick configuration struct (non-secure    \
                                                     address space) */
            #define NVIC_NS                                                                        \
...
typedef ICB_Type SCnSCB_Type;
    ...
    */
     ...
     */
        ...
        /* Function Return Payload (from ARMv8-M Architecture Reference Manual) LR value on entry
         * from Secure BLXNS                   */
        ...
        #define EXC_RETURN_SPSEL                                                                   \
            (0x00000004UL) /* bit [2] stack pointer used to restore context: 0=MSP 1=PSP */
        #define EXC_RETURN_ES                                                                      \
            (0x00000001UL) /* bit [0] security state exception was taken to: 0=Non-secure 1=Secure \
                            */

        /* Integrity Signature (from ARMv8-M Architecture Reference Manual) for exception context
         * stacking                            */
...
/**
  ...
  \details Reads the NVIC pending register and returns the pending bit for the specified device
  specific interrupt. \param [in]      IRQn  Device specific interrupt number. \return             0
  Interrupt status is not pending. \return             1  Interrupt status is pending. \note    IRQn
...
/**
  ...
  \details Reads the active register in the NVIC and returns the active bit for the device specific
  interrupt. \param [in]      IRQn  Device specific interrupt number. \return             0
  Interrupt status is not active. \return             1  Interrupt status is active. \note    IRQn
  must not be negative.
 */
...
/**
  ...
  \details Reads the interrupt target field in the NVIC and returns the interrupt target bit for the
  device specific interrupt. \param [in]      IRQn  Device specific interrupt number. \return 0  if
  interrupt is assigned to Secure \return             1  if interrupt is assigned to Non Secure
  \note    IRQn must not be negative.
 */
...
/**
  ...
  \details Sets the interrupt target field in the NVIC and returns the interrupt target bit for the
  device specific interrupt. \param [in]      IRQn  Device specific interrupt number. \return 0  if
  interrupt is assigned to Secure 1  if interrupt is assigned to Non Secure \note    IRQn must not
  be negative.
 */
...
/**
  ...
  \details Clears the interrupt target field in the NVIC and returns the interrupt target bit for
  the device specific interrupt. \param [in]      IRQn  Device specific interrupt number. \return 0
...
/**
  ...
  \return             Interrupt Priority.
                      Value is aligned automatically to the implemented priority bits of the
  microcontroller.
 */
...
/**
  ...
  \details Decodes an interrupt priority value with a given priority group to
           ...
           In case of a conflict between priority grouping and available
           priority bits (__NVIC_PRIO_BITS) the smallest possible priority group is set.
  \param [in]         Priority   Priority value, which can be retrieved with the function \ref
  NVIC_GetPriority(). \param [in]     PriorityGroup  Used priority group. \param [out]
  pPreemptPriority  Preemptive priority value (starting from 0). \param [out]     pSubPriority
  Subpriority value (starting from 0).
 */
__STATIC_INLINE void NVIC_DecodePriority(
    uint32_t Priority, uint32_t PriorityGroup, uint32_t *const pPreemptPriority,
    ...
    *pPreemptPriority =
        (Priority >> SubPriorityBits) & (uint32_t)((1UL << (PreemptPriorityBits)) - 1UL);
...
/**
  ...
  \details Sets the non-secure priority grouping field when in secure state using the required
  unlock sequence. The parameter PriorityGroup is assigned to the field SCB->AIRCR [10:8] PRIGROUP
  field. Only values from 0..7 are used. In case of a conflict between priority grouping and
  available priority bits (__NVIC_PRIO_BITS), the smallest possible priority group is set. \param
...
/**
  ...
  \details Enables a device specific interrupt in the non-secure NVIC interrupt controller when in
  secure state. \param [in]      IRQn  Device specific interrupt number. \note    IRQn must not be
  negative.
 */
...
/**
  ...
  \details Returns a device specific interrupt enable status from the non-secure NVIC interrupt
  controller when in secure state. \param [in]      IRQn  Device specific interrupt number. \return
  0  Interrupt is not enabled. \return             1  Interrupt is enabled. \note    IRQn must not
  be negative.
 */
...
/**
  ...
  \details Disables a device specific interrupt in the non-secure NVIC interrupt controller when in
  secure state. \param [in]      IRQn  Device specific interrupt number. \note    IRQn must not be
  negative.
 */
...
/**
  ...
  \details Reads the NVIC pending register in the non-secure NVIC when in secure state and returns
  the pending bit for the specified device specific interrupt. \param [in]      IRQn  Device
  specific interrupt number. \return             0  Interrupt status is not pending. \return 1
...
/**
  ...
  \details Sets the pending bit of a device specific interrupt in the non-secure NVIC pending
  register when in secure state. \param [in]      IRQn  Device specific interrupt number. \note IRQn
  must not be negative.
 */
...
/**
  ...
  \details Clears the pending bit of a device specific interrupt in the non-secure NVIC pending
  register when in secure state. \param [in]      IRQn  Device specific interrupt number. \note IRQn
  must not be negative.
 */
...
/**
  ...
  \details Reads the active register in non-secure NVIC when in secure state and returns the active
  bit for the device specific interrupt. \param [in]      IRQn  Device specific interrupt number.
...
/**
  ...
  \details Sets the priority of a non-secure device specific interrupt or a non-secure processor
  exception when in secure state. The interrupt number can be positive to specify a device specific
  interrupt, or negative to specify a processor exception. \param [in]      IRQn  Interrupt number.
  \param [in]  priority  Priority to set.
...
/**
  ...
  \details Reads the priority of a non-secure device specific interrupt or a non-secure processor
  exception when in secure state. The interrupt number can be positive to specify a device specific
  interrupt, or negative to specify a processor exception. \param [in]   IRQn  Interrupt number.
  \return             Interrupt Priority. Value is aligned automatically to the implemented priority
...
__STATIC_INLINE uint32_t TZ_NVIC_GetPriority_NS(IRQn_Type IRQn) {
    ...
    if ((int32_t)(IRQn) >= 0) {
        ...
        return (
            ((uint32_t)SCB_NS->SHPR[(((uint32_t)IRQn) & 0xFUL) - 4UL] >> (8U - __NVIC_PRIO_BITS)));
    }
}
        #endif /*  defined (__ARM_FEATURE_CMSE) &&(__ARM_FEATURE_CMSE == 3U) */
    ...
    /* ##########################  PMU functions and events  #################################### */
        ...
        */
            ...
            #define ARMCM55_PMU_ECC_ERR_ICACHE                                                     \
                0xC011 /*!< Any ECC error in the instruction cache                                 \
                        */
            #define ARMCM55_PMU_ECC_ERR_FATAL_DCACHE                                               \
                0xC012 /*!< Any fatal ECC error in the data cache */
            #define ARMCM55_PMU_ECC_ERR_FATAL_ICACHE                                               \
                0xC013 /*!< Any fatal ECC error in the instruction cache*/
            ...
            #define ARMCM55_PMU_PF_DROP_LINEFILL                                                   \
                0xC102 /*!< A linefill triggered by a prefetcher has been dropped because of lack  \
                          of buffering */
            #define ARMCM55_PMU_NWAMODE_ENTER 0xC200 /*!< No write-allocate mode entry */
            #define ARMCM55_PMU_NWAMODE                                                            \
                0xC201 /*!< Write-allocate store is not allocated into the data cache due to       \
                          no-write-allocate mode */
            #define ARMCM55_PMU_SAHB_ACCESS                                                        \
                0xC300 /*!< Read or write access on the S-AHB interface to the TCM */
            #define ARMCM55_PMU_PAHB_ACCESS                                                        \
                0xC301 /*!< Read or write access to the P-AHB write interface */
            #define ARMCM55_PMU_AXI_WRITE_ACCESS                                                   \
                0xC302 /*!< Any beat access to M-AXI write interface */
            #define ARMCM55_PMU_AXI_READ_ACCESS                                                    \
                0xC303 /*!< Any beat access to M-AXI read interface */
            #define ARMCM55_PMU_DOSTIMEOUT_DOUBLE                                                  \
                0xC400 /*!< Denial of Service timeout has fired twice and caused buffers to drain  \
                          to allow forward progress */
            #define ARMCM55_PMU_DOSTIMEOUT_TRIPLE                                                  \
                0xC401 /*!< Denial of Service timeout has fired three times and blocked the LSU to \
                          force forward progress */
            #define ARMCM55_PMU_CDE_INST_RETIRED                                                   \
                0xC402 /*!< CDE instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_CX1_INST_RETIRED                                               \
                0xC404 /*!< CDE CX1 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_CX2_INST_RETIRED                                               \
                0xC406 /*!< CDE CX2 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_CX3_INST_RETIRED                                               \
                0xC408 /*!< CDE CX3 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX1_INST_RETIRED                                              \
                0xC40A /*!< CDE VCX1 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX2_INST_RETIRED                                              \
                0xC40C /*!< CDE VCX2 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX3_INST_RETIRED                                              \
                0xC40E /*!< CDE VCX3 instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX1_VEC_INST_RETIRED                                          \
                0xC410 /*!< CDE VCX1 Vector instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX2_VEC_INST_RETIRED                                          \
                0xC412 /*!< CDE VCX2 Vector instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_VCX3_VEC_INST_RETIRED                                          \
                0xC414 /*!< CDE VCX3 Vector instruction architecturally executed. */
            #define ARMCM55_PMU_CDE_PRED                                                           \
                0xC416 /*!< Cycles where one or more predicated beats of a CDE instruction         \
                          architecturally executed. */
            #define ARMCM55_PMU_CDE_STALL 0xC417 /*!< Stall cycles caused by a CDE instruction. */
            #define ARMCM55_PMU_CDE_STALL_RESOURCE                                                 \
                0xC418 /*!< Stall cycles caused by a CDE instruction because of resource conflicts \
                        */
            #define ARMCM55_PMU_CDE_STALL_DEPENDENCY                                               \
                0xC419 /*!< Stall cycles caused by a CDE register dependency. */
            #define ARMCM55_PMU_CDE_STALL_CUSTOM                                                   \
                0xC41A /*!< Stall cycles caused by a CDE instruction are generated by the custom   \
                          hardware. */
            #define ARMCM55_PMU_CDE_STALL_OTHER                                                    \
                0xC41B /*!< Stall cycles caused by a CDE instruction are not covered by the other  \
                          counters. */
            #define ARMCM55_PMU_PF_LF_LA_1                                                         \
                0xC41C /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 1. */
            #define ARMCM55_PMU_PF_LF_LA_2                                                         \
                0xC41D /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 2. */
            #define ARMCM55_PMU_PF_LF_LA_3                                                         \
                0xC41E /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 3. */
            #define ARMCM55_PMU_PF_LF_LA_4                                                         \
                0xC41F /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 4. */
            #define ARMCM55_PMU_PF_LF_LA_5                                                         \
                0xC420 /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 5. */
            #define ARMCM55_PMU_PF_LF_LA_6                                                         \
                0xC421 /*!< A data prefetcher line-fill request is made while the lookahead        \
                          distance is 6. */
            #define ARMCM55_PMU_PF_BUFFER_FULL                                                     \
                0xC422 /*!< A data prefetcher request is made while the buffer is full. */
            #define ARMCM55_PMU_PF_BUFFER_MISS                                                     \
                0xC423 /*!< A load requires a line-fill which misses in the data prefetcher        \
                          buffer. */
            #define ARMCM55_PMU_PF_BUFFER_HIT                                                      \
                0xC424 /*!< A load access hits in the data prefetcher buffer. */
...
/**
  ...
  \details Initializes the non-secure System Timer and its interrupt when in secure state, and
  starts the System Tick Timer. Counter is in free running mode to generate periodic interrupts.
  \param [in]  ticks  Number of ticks between two interrupts.
  \return          0  Function succeeded.
  \return          1  Function failed.
  \note    When the variable <b>__Vendor_SysTickConfig</b> is set to 1, then the
           function <b>TZ_SysTick_Config_NS</b> is not included. In this case, the file
  <b><i>device</i>.h</b> must contain a vendor-specific implementation of this function.
...
extern volatile int32_t ITM_RxBuffer; /*!< External variable to receive characters. */
        #define ITM_RXBUFFER_EMPTY                                                                 \
            ((int32_t)0x5AA55AA5U) /*!< Value identifying \ref ITM_RxBuffer is ready for next      \
                                      character. */
...
/**
  ...
  \details Transmits a character via the ITM channel 0, and
           ...
           \li Is blocking when a debugger is connected, but the previous character sent has not
  been transmitted. \param [in]     ch  Character to transmit. \returns            Character to
  transmit.
 */
