...
typedef struct {
    ...
    __IOM uint32_t ACTLR; /*!< Offset: 0x008 (R/W)  Auxiliary Control Register */
        ...
        #define SCnSCB_ACTLR_ITCMUAEN_Msk                                                          \
            (1UL                                                                                   \
             << SCnSCB_ACTLR_ITCMUAEN_Pos) /*!< ACTLR: Instruction TCM Upper Alias Enable Mask */

        #define SCnSCB_ACTLR_ITCMLAEN_Pos                                                          \
            3U /*!< ACTLR: Instruction TCM Lower Alias Enable Position */
        #define SCnSCB_ACTLR_ITCMLAEN_Msk                                                          \
            (1UL                                                                                   \
             << SCnSCB_ACTLR_ITCMLAEN_Pos) /*!< ACTLR: Instruction TCM Lower Alias Enable Mask */
...
typedef struct {
    ...
    __IM uint32_t CALIB; /*!< Offset: 0x00C (R/ )  SysTick Calibration Register */
        ...
        /**
          ...
          \brief    Cortex-M1 Core Debug Registers (DCB registers, SHCSR, and DFSR) are only
          accessible over DAP and not via processor. Therefore they are not covered by the Cortex-M1
          header file.
          @{
         */
...
__STATIC_INLINE uint32_t __NVIC_GetEnableIRQ(IRQn_Type IRQn) {
    if ((int32_t)(IRQn) >= 0) {
        return ((
            uint32_t)(((NVIC->ISER[0U] & (1UL << (((uint32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
        return (0U);
    }
}
...
__STATIC_INLINE uint32_t __NVIC_GetPendingIRQ(IRQn_Type IRQn) {
    if ((int32_t)(IRQn) >= 0) {
        return ((
            uint32_t)(((NVIC->ISPR[0U] & (1UL << (((uint32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
        return (0U);
    }
}
