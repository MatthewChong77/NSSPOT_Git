  ...
  public:
    explicit vector_downward(
        ...
        : allocator_(allocator), own_allocator_(own_allocator), initial_size_(initial_size),
          buffer_minalign_(buffer_minalign), reserved_(0), size_(0), buf_(nullptr), cur_(nullptr),
          scratch_(nullptr) {}
    ...
    vector_downward(vector_downward &&other)
        ...
        : allocator_(other.allocator_), own_allocator_(other.own_allocator_),
          ...
          reserved_(other.reserved_), size_(other.size_), buf_(other.buf_), cur_(other.cur_),
