...
void ReluQuantized(
    const ReluOpData &data, const RuntimeShape &input_shape, const RuntimeShape &output_shape,
...
void Relu6Quantized(
    int8_t lower, int8_t upper, const RuntimeShape &input_shape, const int8_t *input_data,
