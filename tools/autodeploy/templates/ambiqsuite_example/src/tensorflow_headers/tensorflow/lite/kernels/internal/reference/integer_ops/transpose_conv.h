...
inline void TransposeConv(
    const ConvParams &params, const int32_t *output_multiplier, const int32_t *output_shift,
    ...
    const RuntimeShape &output_shape, int8_t *output_data, const RuntimeShape &im2col_shape,
    int8_t *im2col_data, int32_t *scratch_buffer) {
                        ...
                        for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
                            for (int out_channel = 0; out_channel < output_depth; ++out_channel) {
                                ...
                                if ((out_x >= 0) && (out_x < output_width) && (out_y >= 0) &&
                                    ...
                                    const int8_t filter_value = filter_data[Offset(
...
inline void TransposeConv(
    ...
    const int8_t *filter_data, const RuntimeShape &bias_shape, const Scalar *bias_data,
    const RuntimeShape &output_shape, int16_t *output_data, const RuntimeShape &im2col_shape,
    int8_t *im2col_data, Scalar *scratch_buffer) {
    const int stride_width = params.stride_width;
    const int stride_height = params.stride_height;
    const int pad_width = params.padding_values.width;
    const int pad_height = params.padding_values.height;
