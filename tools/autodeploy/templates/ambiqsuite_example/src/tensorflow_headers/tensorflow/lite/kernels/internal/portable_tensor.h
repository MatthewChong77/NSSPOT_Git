...
template <typename T> class VectorOfTensors {
  public:
    ...
    VectorOfTensors(const TfLiteContext &context, const TfLiteIntArray &tensor_list) {
...
class VectorOfQuantizedTensors : public VectorOfTensors<uint8_t> {
  public:
    // Build with the tensors in 'tensor_list'.
    VectorOfQuantizedTensors(const TfLiteContext &context, const TfLiteIntArray &tensor_list)
