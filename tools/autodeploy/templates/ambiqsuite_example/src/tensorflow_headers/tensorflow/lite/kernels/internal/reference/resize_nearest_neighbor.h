...
inline int32_t GetNearestNeighbor(
    const int input_value, const int32_t input_size, const int32_t output_size,
    ...
    int32_t output_value = std::min(
        align_corners ? static_cast<int32_t>(TfLiteRound((input_value + offset) * scale))
