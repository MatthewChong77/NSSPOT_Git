                ...
                for (int y = 0; y < extended_output_shape.Dims(3); ++y) {
                    ...
                    for (int x = 0; x < extended_output_shape.Dims(4); ++x) {
                        ...
                        for (int c = 0; c < extended_output_shape.Dims(5); ++c) {
                            output_data[output_offset_c] = binary_func(
                                input1_data[input1_offset_c], input2_data[input2_offset_c], params);
...
inline void AddElementwise(
    int size, const ArithmeticParams &params, const int8_t *input1_data, const int8_t *input2_data,
    int8_t *output_data) {
    ElementWise(
        size, params, input1_data, input2_data, output_data, CheckArithmeticParams, AddFunc);
}

inline void
Add(const ArithmeticParams &params, const RuntimeShape &input1_shape, const int8_t *input1_data,
...
inline void BroadcastAdd6DSlow(
    const ArithmeticParams &params, const RuntimeShape &input1_shape, const int8_t *input1_data,
    const RuntimeShape &input2_shape, const int8_t *input2_data, const RuntimeShape &output_shape,
    int8_t *output_data) {
    BroadcastBinaryFunction6DSlow(
        params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
