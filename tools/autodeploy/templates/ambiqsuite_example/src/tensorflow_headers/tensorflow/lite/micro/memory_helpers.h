...
// Returns an increased size that's a multiple of alignment.
template <typename T> size_t AlignSizeUp(size_t count = 1) {
...
TfLiteStatus
BytesRequiredForTensor(const tflite::Tensor &flatbuffer_tensor, size_t *bytes, size_t *type_size);
...
// output dimension.
TfLiteStatus AllocateOutputDimensionsFromInput(
